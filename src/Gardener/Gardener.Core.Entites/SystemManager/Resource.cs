...
namespace Gardener.Core.Entites
{
 ...
 new Resource(){Id=Guid.Parse("91517bf1-ef41-4ddb-8daa-5022c59d2c73"),ParentId=Guid.Parse("c2090656-8a05-4e67-b7ea-62f178639620"),Name="用户管理",Icon="user",Remark="用户管理",Key="system_manager_user",Path="/user_auth/user",CreatedTime=DateTimeOffset.Now,IsDeleted=false,IsLocked=false,Type=(ResourceType)1000,Order=10},
 new Resource(){Id=Guid.Parse("1cba3770-9b4e-4c69-9973-07c4f8555a3f"),ParentId=Guid.Parse("c2090656-8a05-4e67-b7ea-62f178639620"),Name="角色管理",Icon="user-switch",Remark="",Key="system_manager_role",Path="/user_auth/role",CreatedTime=DateTimeOffset.Now,IsDeleted=false,IsLocked=false,Type=(ResourceType)1000,Order=20},
