...
namespace Gardener.Core.Entites
{
 ...
 new Resource(){Id=Guid.Parse("2dd1a78c-f725-461b-8bc6-66112a7e156c"),ParentId=Guid.Parse("c2090656-8a05-4e67-b7ea-62f178639620"),Name="审计管理",Icon="audit",Remark="审计管理",Key="system_manager_audit",Path="",CreatedTime=DateTimeOffset.Now,IsDeleted=false,IsLocked=false,Type=(ResourceType)1000,Order=60},
 ...
 new Resource(){Id=Guid.Parse("fb4f6cc5-8f3a-4885-aba4-23a5a8c70b41"),ParentId=Guid.Parse("c2090656-8a05-4e67-b7ea-62f178639620"),Name="登录管理",Icon="idcard",Remark="",Key="system_manager_user_token",Path="system_manager/user-token",CreatedTime=DateTimeOffset.Now,IsDeleted=false,IsLocked=false,Type=(ResourceType)1000,Order=70},
 new Resource(){Id=Guid.Parse("3d007d84-d209-49e2-94ca-11ad2a3dd91d"),ParentId=Guid.Parse("fb4f6cc5-8f3a-4885-aba4-23a5a8c70b41"),Name="删除用户Token",Icon="",Remark="",Key="system_manager_user_token_delete",Path="",CreatedTime=DateTimeOffset.Now,IsDeleted=false,IsLocked=false,Type=(ResourceType)2000,Order=0},
 new Resource(){Id=Guid.Parse("c98160ef-ce87-4a1b-bfb3-09fc79d2a34a"),ParentId=Guid.Parse("fb4f6cc5-8f3a-4885-aba4-23a5a8c70b41"),Name="刷新用户Token",Icon="",Remark="",Key="system_manager_user_token_refresh",Path="",CreatedTime=DateTimeOffset.Now,IsDeleted=false,IsLocked=false,Type=(ResourceType)2000,Order=0},
 new Resource(){Id=Guid.Parse("0cbb3d40-de41-483e-a76c-3d85682176af"),ParentId=Guid.Parse("fb4f6cc5-8f3a-4885-aba4-23a5a8c70b41"),Name="锁定用户Token",Icon="",Remark="",Key="system_manager_user_token_lock",Path="",CreatedTime=DateTimeOffset.Now,IsDeleted=false,IsLocked=false,Type=(ResourceType)2000,Order=0},
 new Resource(){Id=Guid.Parse("f077211f-0e79-44a3-935c-0f704f6a5962"),ParentId=Guid.Parse("fb4f6cc5-8f3a-4885-aba4-23a5a8c70b41"),Name="删除选中用户Token",Icon="",Remark="",Key="system_manager_user_token_delete_selected",Path="",CreatedTime=DateTimeOffset.Now,IsDeleted=false,IsLocked=false,Type=(ResourceType)2000,Order=0}
 };
