...
namespace Gardener.Core.Entites
{
    ...
    /// </summary>
    [Description("资源信息")]
    public class Resource : Entity<Guid>, IEntitySeedData<Resource>, IEntityTypeBuilder<Resource>, ILockEntity
    {
        /// <summary>
        /// 资源名称
        /// </summary>
...
new Resource(){Id=Guid.Parse("de8658ed-e997-4c07-861e-721c6275ca38"),ParentId=Guid.Parse("3c124d95-dd76-4903-b240-a4fe4df93868"),Name="系统权限相关接口",Icon="",Remark="",Key="system_auth_api",Path="",CreatedTime=DateTimeOffset.Now,IsDeleted=false,IsLocked=false,Type=(ResourceType)3000,Order=-1},
...
new Resource(){Id=Guid.Parse("05ad7e32-3101-465f-bec1-01ef8fab70bf"),ParentId=Guid.Parse("3c124d95-dd76-4903-b240-a4fe4df93868"),Name="基础服务接口",Icon="",Remark="基础服务接口",Key="system_base_service",Path="",CreatedTime=DateTimeOffset.Now,IsDeleted=false,IsLocked=false,Type=(ResourceType)3000,Order=-1},
new Resource(){Id=Guid.Parse("c8540d46-fe88-4858-8ab7-f8b427695e77"),ParentId=Guid.Parse("de8658ed-e997-4c07-861e-721c6275ca38"),Name="Token 刷新",Icon="",Remark="",Key="system_auth_api_refresh_token",Path="api/authorize/refresh-token",CreatedTime=DateTimeOffset.Now,IsDeleted=false,IsLocked=false,Type=(ResourceType)3000,Order=1},
...
new Resource(){Id=Guid.Parse("ed0b45b7-03be-44d3-98cd-c2b9447f7014"),ParentId=Guid.Parse("de8658ed-e997-4c07-861e-721c6275ca38"),Name="删除当前用户的刷新token",Icon="",Remark="",Key="system_auth_api_delete_current_user_refresh_token",Path="api/authorize/current-user-refresh-token",CreatedTime=DateTimeOffset.Now,IsDeleted=false,IsLocked=false,Type=(ResourceType)3000,Order=6},
new Resource(){Id=Guid.Parse("8910d2d6-784b-4331-a5bc-22e2a943aa9f"),ParentId=Guid.Parse("de8658ed-e997-4c07-861e-721c6275ca38"),Name="获取当前用户的所有菜单",Icon="",Remark="",Key="system_auth_api_current_user_menus",Path="api/authorize/current-user-menus",CreatedTime=DateTimeOffset.Now,IsDeleted=false,IsLocked=false,Type=(ResourceType)3000,Order=5},
new Resource(){Id=Guid.Parse("ba6dc63f-dff8-4899-922c-38f2b4ce415d"),ParentId=Guid.Parse("de8658ed-e997-4c07-861e-721c6275ca38"),Name="获取当前用户资源",Icon="",Remark="",Key="system_auth_api_current_user_resources",Path="api/authorize/current-user-resources",CreatedTime=DateTimeOffset.Now,IsDeleted=false,IsLocked=false,Type=(ResourceType)3000,Order=4},
new Resource(){Id=Guid.Parse("825e4fbd-c88c-4028-b864-a7d7363e9550"),ParentId=Guid.Parse("de8658ed-e997-4c07-861e-721c6275ca38"),Name="获取当前用户信息",Icon="",Remark="",Key="system_auth_api_current_user",Path="api/authorize/current-user",CreatedTime=DateTimeOffset.Now,IsDeleted=false,IsLocked=false,Type=(ResourceType)3000,Order=3},
new Resource(){Id=Guid.Parse("8b78e71e-bd7f-4264-80cd-0ec2964b4f63"),ParentId=Guid.Parse("de8658ed-e997-4c07-861e-721c6275ca38"),Name="查看用户角色",Icon="",Remark="",Key="system_auth_api_current_user_roles",Path="api/authorize/current-user-roles",CreatedTime=DateTimeOffset.Now,IsDeleted=false,IsLocked=false,Type=(ResourceType)3000,Order=2},
...
new Resource(){Id=Guid.Parse("9c02b28b-8f69-4da4-987e-74bf824c3520"),ParentId=Guid.Parse("d1c558a6-6d54-4ba0-872a-c61cd04db9bb"),Name="查询数据审计列表数据",Icon="",Remark="查询数据审计列表数据",Key="system_manager_audit_entity_search_list_api",Path="api/audit-entity/search",CreatedTime=DateTimeOffset.Now,IsDeleted=false,IsLocked=false,Type=(ResourceType)3000,Order=0},
new Resource(){Id=Guid.Parse("20abd81f-60f7-4077-8e38-5d22f2d12e9f"),ParentId=Guid.Parse("1cba3770-9b4e-4c69-9973-07c4f8555a3f"),Name="查询角色详情",Icon="",Remark="查询角色详情",Key="user_auth_role_detail_api",Path="api/role/{id}",CreatedTime=DateTimeOffset.Now,IsDeleted=false,IsLocked=false,Type=(ResourceType)3000,Order=8},
...
new Resource(){Id=Guid.Parse("e6e477f3-8dd8-4657-adde-cc2c34017775"),ParentId=Guid.Parse("25dcaaca-6f97-45f3-952d-05112f07c677"),Name="查询资源数据详情",Icon="",Remark="查询资源数据详情",Key="user_auth_resource_get_detail_api",Path="api/resource/{id}",CreatedTime=DateTimeOffset.Now,IsDeleted=false,IsLocked=false,Type=(ResourceType)3000,Order=-1},
new Resource(){Id=Guid.Parse("e30bbf62-d6d3-4e72-ac1a-abb285587632"),ParentId=Guid.Parse("25dcaaca-6f97-45f3-952d-05112f07c677"),Name="查询资源列表数据",Icon="",Remark="查询资源列表数据",Key="user_auth_get_resource_tree_api",Path="api/resource/tree",CreatedTime=DateTimeOffset.Now,IsDeleted=false,IsLocked=false,Type=(ResourceType)3000,Order=-1},
new Resource(){Id=Guid.Parse("cc181382-afc6-4036-9b90-4e52e95ee9f6"),ParentId=Guid.Parse("25dcaaca-6f97-45f3-952d-05112f07c677"),Name="查询资源子集资源",Icon="",Remark="查询资源子集资源",Key="user_auth_resource_children_list_api",Path="api/resource/{id}/children",CreatedTime=DateTimeOffset.Now,IsDeleted=false,IsLocked=false,Type=(ResourceType)3000,Order=-1},
...
new Resource(){Id=Guid.Parse("0b133140-4c89-4463-aea6-75f7f0ddebdc"),ParentId=Guid.Parse("925c3162-155c-4644-8ca2-075f9fc76235"),Name="查询附件列表数据",Icon="null",Remark="查询附件列表数据",Key="system_manager_attachment_list_api",Path="api/attachment/search",CreatedTime=DateTimeOffset.Now,IsDeleted=false,IsLocked=false,Type=(ResourceType)3000,Order=-1},
...
new Resource(){Id=Guid.Parse("dc7cf259-5c60-47c9-a02b-1fc9b04c9582"),ParentId=Guid.Parse("91517bf1-ef41-4ddb-8daa-5022c59d2c73"),Name="查询用户列表数据",Icon="",Remark="查询用户列表数据",Key="user_auth_user_list_api",Path="api/user/search/{pageindex}/{pagesize}",CreatedTime=DateTimeOffset.Now,IsDeleted=false,IsLocked=false,Type=(ResourceType)3000,Order=-1},
...
new Resource(){Id=Guid.Parse("b1d51f43-1977-4f46-a07d-14ac19090286"),ParentId=Guid.Parse("4dd77af7-1947-4166-9006-ee4e9fe84472"),Name="编辑资源",Icon="",Remark="",Key="user_auth_resource_edit_api",Path="api/resource",CreatedTime=DateTimeOffset.Now,IsDeleted=false,IsLocked=false,Type=(ResourceType)3000,Order=0},
...
new Resource(){Id=Guid.Parse("b11e633f-0253-4345-b811-e96ced174011"),ParentId=Guid.Parse("bc41e1b6-148a-4f67-a036-272393e5cf1f"),Name="添加资源",Icon="",Remark="",Key="user_auth_resource_add_api",Path="api/resource",CreatedTime=DateTimeOffset.Now,IsDeleted=false,IsLocked=false,Type=(ResourceType)3000,Order=0},
new Resource(){Id=Guid.Parse("8e7f90eb-c5d5-40f7-bf62-cf0d3f1d8c55"),ParentId=Guid.Parse("799d63fd-48e7-40c2-84e7-a6b36f2c19f3"),Name="获取角色所有资源",Icon="",Remark="",Key="user_auth_role_get_resource_api",Path="api/role/{roleid}/resource",CreatedTime=DateTimeOffset.Now,IsDeleted=false,IsLocked=false,Type=(ResourceType)3000,Order=1},
new Resource(){Id=Guid.Parse("976aab97-4a39-4d6a-896c-f909f62d4728"),ParentId=Guid.Parse("799d63fd-48e7-40c2-84e7-a6b36f2c19f3"),Name="为角色分配权限（重置）",Icon="",Remark="",Key="user_auth_role_set_resource_api",Path="api/role/{roleid}/resource",CreatedTime=DateTimeOffset.Now,IsDeleted=false,IsLocked=false,Type=(ResourceType)3000,Order=0},
new Resource(){Id=Guid.Parse("ba7c2ed3-e1e9-44de-b48f-092f02a9d811"),ParentId=Guid.Parse("799d63fd-48e7-40c2-84e7-a6b36f2c19f3"),Name="查询所有资源",Icon="",Remark="",Key="user_auth_get_resource_tree_api",Path="api/resource/tree",CreatedTime=DateTimeOffset.Now,IsDeleted=false,IsLocked=false,Type=(ResourceType)3000,Order=2},
new Resource(){Id=Guid.Parse("74068df7-300e-4f3a-ab2c-f78b93a78d74"),ParentId=Guid.Parse("b71bbc5f-83a3-4065-b561-cb4b69b4a507"),Name="锁定角色",Icon="",Remark="",Key="user_auth_role_lock_api",Path="api/role/{id}/lock/{islocked}",CreatedTime=DateTimeOffset.Now,IsDeleted=false,IsLocked=false,Type=(ResourceType)3000,Order=0},
new Resource(){Id=Guid.Parse("3201dcea-913b-4b30-a596-523c25311cb1"),ParentId=Guid.Parse("d998802f-776e-4137-bc63-d8d818464f98"),Name="物理删除多个附件",Icon="null",Remark="物理删除多个附件",Key="system_manager_attachment_delete_selected_api",Path="api/attachment/deletes",CreatedTime=DateTimeOffset.Now,IsDeleted=false,IsLocked=false,Type=(ResourceType)3000,Order=0},
new Resource(){Id=Guid.Parse("468ebc0c-01ef-4ddb-8369-5807112c8b51"),ParentId=Guid.Parse("d982a072-4681-45d9-8489-7a14218adb04"),Name="逻辑删除单个角色",Icon="",Remark="",Key="user_auth_role_delete_api",Path="api/role/fake-delete/{id}",CreatedTime=DateTimeOffset.Now,IsDeleted=false,IsLocked=false,Type=(ResourceType)3000,Order=0},
...
new Resource(){Id=Guid.Parse("7f6eb4a1-b046-438e-a50a-0311da7488b6"),ParentId=Guid.Parse("99b6dcf1-1eae-4653-b30d-423c9c8dc95c"),Name="添加用户",Icon="",Remark="",Key="user_auth_user_add_api",Path="api/user",CreatedTime=DateTimeOffset.Now,IsDeleted=false,IsLocked=false,Type=(ResourceType)3000,Order=0},
new Resource(){Id=Guid.Parse("c876dd56-06fe-4a9b-9cd2-d2f47e867496"),ParentId=Guid.Parse("d5756ad0-6a8b-4462-907f-1c52a1e11369"),Name="逻辑删除单个用户",Icon="",Remark="",Key="user_auth_user_delete_api",Path="api/user/fake-delete/{id}",CreatedTime=DateTimeOffset.Now,IsDeleted=false,IsLocked=false,Type=(ResourceType)3000,Order=0},
new Resource(){Id=Guid.Parse("36465515-40c7-4e16-94fc-14be8b03e247"),ParentId=Guid.Parse("46cad808-0d0b-42bb-a134-3ad6db8ebf54"),Name="用户设置角色",Icon="",Remark="",Key="user_auth_user_role_edit_api",Path="api/user/{userid}/role",CreatedTime=DateTimeOffset.Now,IsDeleted=false,IsLocked=false,Type=(ResourceType)3000,Order=0},
new Resource(){Id=Guid.Parse("2e7a9334-5f50-4d11-999b-8c31f3db2a17"),ParentId=Guid.Parse("46cad808-0d0b-42bb-a134-3ad6db8ebf54"),Name="角色查询可用",Icon="",Remark="",Key="user_auth_role_get_effective_roles_api",Path="api/role/effective",CreatedTime=DateTimeOffset.Now,IsDeleted=false,IsLocked=false,Type=(ResourceType)3000,Order=1},
new Resource(){Id=Guid.Parse("c7e92b64-0434-48e3-bab3-c13b8a536580"),ParentId=Guid.Parse("87377abe-785d-426c-b052-f706a2c7173d"),Name="锁定用户",Icon="",Remark="",Key="user_auth_user_lock_api",Path="api/user/{id}/lock/{islocked}",CreatedTime=DateTimeOffset.Now,IsDeleted=false,IsLocked=false,Type=(ResourceType)3000,Order=0},
new Resource(){Id=Guid.Parse("6e0add35-dcb1-4d39-b336-1c732ce811e5"),ParentId=Guid.Parse("0aa9b237-dab8-472e-b2e6-af9c0af9f916"),Name="编辑用户",Icon="",Remark="",Key="user_auth_user_edit_api",Path="api/user",CreatedTime=DateTimeOffset.Now,IsDeleted=false,IsLocked=false,Type=(ResourceType)3000,Order=0},
new Resource(){Id=Guid.Parse("ba063442-52c6-4f51-a87f-44bb22c75de9"),ParentId=Guid.Parse("13e7d01e-93ca-429c-b412-ff6fa5b6a026"),Name="编辑角色",Icon="",Remark="",Key="user_auth_role_edit_api",Path="api/role",CreatedTime=DateTimeOffset.Now,IsDeleted=false,IsLocked=false,Type=(ResourceType)3000,Order=0},
new Resource(){Id=Guid.Parse("23544f6f-ce09-4de5-b496-d283c7935f01"),ParentId=Guid.Parse("67501fd4-4fbf-48c2-b383-f3a2085268ed"),Name="添加角色",Icon="",Remark="",Key="user_auth_role_add_api",Path="api/role",CreatedTime=DateTimeOffset.Now,IsDeleted=false,IsLocked=false,Type=(ResourceType)3000,Order=0},
new Resource(){Id=Guid.Parse("02ae4ca7-8a18-49c0-a98b-3dbc823760b5"),ParentId=Guid.Parse("46cad808-0d0b-42bb-a134-3ad6db8ebf54"),Name="查询用户角色",Icon="",Remark="",Key="user_auth_user_get_roles_api",Path="api/user/{userid}/roles",CreatedTime=DateTimeOffset.Now,IsDeleted=false,IsLocked=false,Type=(ResourceType)3000,Order=2},
new Resource(){Id=Guid.Parse("68a5cfb5-86ce-4287-bb06-6a760e8458c9"),ParentId=Guid.Parse("ea0fb035-1f06-4f61-9946-8df027a7462d"),Name="编辑用户头像",Icon="",Remark="编辑用户头像",Key="user_auth_user_list_edit_avatar_api",Path="api/user/avatar",CreatedTime=DateTimeOffset.Now,IsDeleted=false,IsLocked=false,Type=(ResourceType)3000,Order=0},
