...
namespace Gardener.Core.Entites
{
 ...
 new ResourceFunction(){ResourceId = Guid.Parse("91517bf1-ef41-4ddb-8daa-5022c59d2c73"),FunctionId = Guid.Parse("cbc8aff4-6dc0-41f2-b684-caba8e0657ac"),CreatedTime= DateTimeOffset.Now},
 new ResourceFunction(){ResourceId = Guid.Parse("34b187cc-dd6f-4edf-a22c-a339be59d5c3"),FunctionId = Guid.Parse("c715a6d5-cd99-4c94-8760-936817c1e09c"),CreatedTime= DateTimeOffset.Now},
 ...
 new ResourceFunction(){ResourceId = Guid.Parse("13e7d01e-93ca-429c-b412-ff6fa5b6a026"),FunctionId = Guid.Parse("b38fb0cc-4275-4d1f-8bb7-6f5a962bcc35"),CreatedTime= DateTimeOffset.Now},
 ...
 new ResourceFunction(){ResourceId = Guid.Parse("25535592-81a1-42dd-8a55-509f2c852ff9"),FunctionId = Guid.Parse("715a2905-da23-405d-98a0-1a1222f7d101"),CreatedTime= DateTimeOffset.Now},
 ...
 new ResourceFunction(){ResourceId = Guid.Parse("f4fa035f-27ae-4eee-b006-3cbfac3d2172"),FunctionId = Guid.Parse("c715a6d5-cd99-4c94-8760-936817c1e09c"),CreatedTime= DateTimeOffset.Now},
 new ResourceFunction(){ResourceId = Guid.Parse("0fd84267-ee22-47c4-b41c-ce654eba29d9"),FunctionId = Guid.Parse("7a3399b3-6003-4aae-8e24-2e478992630e"),CreatedTime= DateTimeOffset.Now},
 new ResourceFunction(){ResourceId = Guid.Parse("0fd84267-ee22-47c4-b41c-ce654eba29d9"),FunctionId = Guid.Parse("715a2905-da23-405d-98a0-1a1222f7d101"),CreatedTime= DateTimeOffset.Now},
 new ResourceFunction(){ResourceId = Guid.Parse("3d6e9553-2baf-4d9d-8a82-65de1c7d7ece"),FunctionId = Guid.Parse("89954833-64a5-4c87-a717-9c863ca3b263"),CreatedTime= DateTimeOffset.Now},
 new ResourceFunction(){ResourceId = Guid.Parse("4e845d07-33a4-4dc4-ba7f-8568f88b9d68"),FunctionId = Guid.Parse("65a3c1ee-f5cf-48eb-9bf0-3d4db44257e4"),CreatedTime= DateTimeOffset.Now},
 new ResourceFunction(){ResourceId = Guid.Parse("1efd01cf-42f2-45c7-95f2-84be55e65646"),FunctionId = Guid.Parse("cbc8aff4-6dc0-41f2-b684-caba8e0657ac"),CreatedTime= DateTimeOffset.Now},
 ...
 new ResourceFunction(){ResourceId = Guid.Parse("25535592-81a1-42dd-8a55-509f2c852ff9"),FunctionId = Guid.Parse("05153ee4-dc99-4834-b398-5999f7dc8d01"),CreatedTime= DateTimeOffset.Now},
 ...
 new ResourceFunction(){ResourceId = Guid.Parse("50062351-8235-4da1-9f90-4917d0e8abe0"),FunctionId = Guid.Parse("b952b41e-b3e9-4c53-9a7d-6b561acf4bc4"),CreatedTime= DateTimeOffset.Now},
 ...
 new ResourceFunction(){ResourceId = Guid.Parse("186bca5f-cc2c-427e-a58a-dbb81641a296"),FunctionId = Guid.Parse("a96bb19e-794e-4fe0-ad39-f423df44f633"),CreatedTime= DateTimeOffset.Now},
 ...
 new ResourceFunction(){ResourceId = Guid.Parse("c4991844-d3b4-4f9a-9c90-c13114515796"),FunctionId = Guid.Parse("b79d2f63-487c-44c8-b7d3-1e882994789b"),CreatedTime= DateTimeOffset.Now},
 ...
 new ResourceFunction(){ResourceId = Guid.Parse("1cba3770-9b4e-4c69-9973-07c4f8555a3f"),FunctionId = Guid.Parse("498638f7-dc92-4d0e-ac5e-26e48cf87a8d"),CreatedTime= DateTimeOffset.Now},
 new ResourceFunction(){ResourceId = Guid.Parse("fb4f6cc5-8f3a-4885-aba4-23a5a8c70b41"),FunctionId = Guid.Parse("23f69ca2-fcef-4cc7-93ac-484a1e38ba22"),CreatedTime= DateTimeOffset.Now},
 new ResourceFunction(){ResourceId = Guid.Parse("3d007d84-d209-49e2-94ca-11ad2a3dd91d"),FunctionId = Guid.Parse("98fdbccd-fde2-414d-9cfe-0d6cf3339d58"),CreatedTime= DateTimeOffset.Now},
 new ResourceFunction(){ResourceId = Guid.Parse("c98160ef-ce87-4a1b-bfb3-09fc79d2a34a"),FunctionId = Guid.Parse("23f69ca2-fcef-4cc7-93ac-484a1e38ba22"),CreatedTime= DateTimeOffset.Now},
 new ResourceFunction(){ResourceId = Guid.Parse("0cbb3d40-de41-483e-a76c-3d85682176af"),FunctionId = Guid.Parse("a0e6ea28-fcd8-4c9b-b937-35a2afa10b86"),CreatedTime= DateTimeOffset.Now},
 new ResourceFunction(){ResourceId = Guid.Parse("f077211f-0e79-44a3-935c-0f704f6a5962"),FunctionId = Guid.Parse("453f751d-70d5-4725-ac7c-ad083bd5253d"),CreatedTime= DateTimeOffset.Now}
