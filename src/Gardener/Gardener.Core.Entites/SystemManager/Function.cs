...
namespace Gardener.Core.Entites
{
 ...
 new Function(){Id = Guid.Parse("056ff2f6-009b-40ff-a1b9-a6983e471967"),EnableAudit=true,Group="系统管理",Service="功能服务",Summary="启用或禁用审计",Key="1DC1B5ECD34759A80CE8C468366A378F",Description="启用或禁用审计",Path="/api/function/{id}/enable-audit/{enableaudit}",Method=(HttpMethodType)2,CreatedTime= DateTimeOffset.Now},
 ...
 new Function(){Id = Guid.Parse("973edc2c-42e1-473e-9656-a43890663d8a"),EnableAudit=false,Group="系统管理",Service="部门服务",Summary="查询所有可以用的",Key="3D033D8178E68247D2C34E53F00D468F",Description="查询所有可以用的(在有IsDelete、IsLock字段时会自动过滤)",Path="/api/dept/all-usable",Method=(HttpMethodType)0,CreatedTime= DateTimeOffset.Now},
 new Function(){Id = Guid.Parse("85f94b4c-e897-4f3c-b80a-c7ddb8ebf1b5"),EnableAudit=false,Group="系统管理",Service="部门服务",Summary="搜索",Key="E6BAA5C7F35ED0CBD3902A30349A992B",Description="搜索数据",Path="/api/dept/search",Method=(HttpMethodType)1,CreatedTime= DateTimeOffset.Now},
 new Function(){Id = Guid.Parse("c715a6d5-cd99-4c94-8760-936817c1e09c"),EnableAudit=false,Group="系统管理",Service="岗位管理服务",Summary="搜索",Key="9A501F3D2F0A3A2D47A17D6F42042CD5",Description="搜索数据",Path="/api/position/search",Method=(HttpMethodType)1,CreatedTime= DateTimeOffset.Now},
 new Function(){Id = Guid.Parse("7229563b-7311-41b8-947b-f07d58fa6c87"),EnableAudit=false,Group="系统管理",Service="资源服务",Summary="查询所有可以用的",Key="6C03A3540C36BB4BD1BB9F1606F0F550",Description="查询所有可以用的(在有IsDelete、IsLock字段时会自动过滤)",Path="/api/resource/all-usable",Method=(HttpMethodType)0,CreatedTime= DateTimeOffset.Now},
 new Function(){Id = Guid.Parse("1295aed2-ae71-411f-9542-d50f75432840"),EnableAudit=false,Group="系统管理",Service="资源服务",Summary="搜索",Key="24C5B533C5DDC7D494830FF5E28F6EC2",Description="搜索数据",Path="/api/resource/search",Method=(HttpMethodType)1,CreatedTime= DateTimeOffset.Now},
 new Function(){Id = Guid.Parse("5efd6ab4-a9d3-4742-9a48-fb54a1b1e463"),EnableAudit=false,Group="系统管理",Service="角色服务",Summary="查询所有可以用的",Key="D4F99E0AE4263D647F3440B66DB7AC7B",Description="查询所有可以用的(在有IsDelete、IsLock字段时会自动过滤)",Path="/api/role/all-usable",Method=(HttpMethodType)0,CreatedTime= DateTimeOffset.Now},
 new Function(){Id = Guid.Parse("498638f7-dc92-4d0e-ac5e-26e48cf87a8d"),EnableAudit=false,Group="系统管理",Service="角色服务",Summary="搜索",Key="4B11C588FC856C862E41859F189370C0",Description="搜索数据",Path="/api/role/search",Method=(HttpMethodType)1,CreatedTime= DateTimeOffset.Now},
 new Function(){Id = Guid.Parse("cbc8aff4-6dc0-41f2-b684-caba8e0657ac"),EnableAudit=false,Group="系统管理",Service="用户服务",Summary="搜索",Key="04608E487B494D4597BBAD83DF59D2FF",Description="搜索用户数据",Path="/api/user/search",Method=(HttpMethodType)1,CreatedTime= DateTimeOffset.Now},
 new Function(){Id = Guid.Parse("bdab8953-956d-4b1a-945b-b1806e9ac749"),EnableAudit=false,Group="系统管理",Service="用户服务",Summary="查询所有可以用的",Key="073E6E78B3A88E41DBDC46DCA32C4837",Description="查询所有可以用的(在有IsDelete、IsLock字段时会自动过滤)",Path="/api/user/all-usable",Method=(HttpMethodType)0,CreatedTime= DateTimeOffset.Now},
 new Function(){Id = Guid.Parse("42b3486a-8ea0-4296-a526-7cd3ef9ea73a"),EnableAudit=false,Group="系统管理",Service="附件服务",Summary="查询所有可以用的",Key="6B7B11626AE0ABB28C5331DB67DACAA0",Description="查询所有可以用的(在有IsDelete、IsLock字段时会自动过滤)",Path="/api/attachment/all-usable",Method=(HttpMethodType)0,CreatedTime= DateTimeOffset.Now},
 new Function(){Id = Guid.Parse("1fe857c9-c027-4ca3-b8f8-21ec2c1f5cde"),EnableAudit=false,Group="系统管理",Service="审计数据服务",Summary="查询所有可以用的",Key="280713DC4618277C7BF307117835ED7B",Description="查询所有可以用的(在有IsDelete、IsLock字段时会自动过滤)",Path="/api/audit-entity/all-usable",Method=(HttpMethodType)0,CreatedTime= DateTimeOffset.Now},
 new Function(){Id = Guid.Parse("4a127124-6348-4db1-aa38-5f3af2c8efdf"),EnableAudit=false,Group="系统管理",Service="审计操作服务",Summary="查询所有可以用的",Key="A99DB9777E1C5C11D2FA6A8957F696E8",Description="查询所有可以用的(在有IsDelete、IsLock字段时会自动过滤)",Path="/api/audit-operation/all-usable",Method=(HttpMethodType)0,CreatedTime= DateTimeOffset.Now},
 new Function(){Id = Guid.Parse("b79d2f63-487c-44c8-b7d3-1e882994789b"),EnableAudit=false,Group="系统管理",Service="功能服务",Summary="查询所有可以用的",Key="1CCC2478B5AC5FDDB537DCD33166ABF7",Description="查询所有可以用的(在有IsDelete、IsLock字段时会自动过滤)",Path="/api/function/all-usable",Method=(HttpMethodType)0,CreatedTime= DateTimeOffset.Now},
 ...
 new Function(){Id = Guid.Parse("d22007c6-fada-4ef1-bafa-08455b767883"),EnableAudit=false,Group="系统管理",Service="岗位管理服务",Summary="分页查询",Key="F543F08AB768F7D444481F5D7EB52373",Description="根据分页参数，分页获取数据",Path="/api/position/page/{pageindex}/{pagesize}",Method=(HttpMethodType)0,CreatedTime= DateTimeOffset.Now},
 ...
 new Function(){Id = Guid.Parse("f6843cdf-133d-4eb8-92b2-c36fe63ea9d7"),EnableAudit=true,Group="系统管理",Service="岗位管理服务",Summary="锁定",Key="9501F9B0B5D4867FF65611B203B43D69",Description="根据主键锁定或解锁数据（必须有IsLock才能生效）",Path="/api/position/{id}/lock/{islocked}",Method=(HttpMethodType)2,CreatedTime= DateTimeOffset.Now},
 ...
 new Function(){Id = Guid.Parse("b56c4126-411c-445e-86aa-a91a5ce816d4"),EnableAudit=false,Group="系统管理",Service="岗位管理服务",Summary="查询所有可以用的",Key="C47AACD68B1EF833AAC0EC90CD878FDD",Description="查询所有可以用的(在有IsDelete、IsLock字段时会自动过滤)",Path="/api/position/all-usable",Method=(HttpMethodType)0,CreatedTime= DateTimeOffset.Now},
 new Function(){Id = Guid.Parse("69f70da1-fb4e-443f-9efe-e3d12cc95eed"),EnableAudit=false,Group="系统管理",Service="岗位管理服务",Summary="查询所有",Key="88BAC4E29D23BD095207644BB397E5EE",Description="查找到所有数据",Path="/api/position/all",Method=(HttpMethodType)0,CreatedTime= DateTimeOffset.Now},
 ...
 new Function(){Id = Guid.Parse("89954833-64a5-4c87-a717-9c863ca3b263"),EnableAudit=true,Group="系统管理",Service="岗位管理服务",Summary="批量逻辑删除",Key="710C2B0A026A9C3FF0D6235FCD8E0F26",Description="根据多个主键批量逻辑删除",Path="/api/position/fake-deletes",Method=(HttpMethodType)1,CreatedTime= DateTimeOffset.Now},
 new Function(){Id = Guid.Parse("ed340c0c-9b63-45f4-942a-c8a14c4491d3"),EnableAudit=true,Group="系统管理",Service="岗位管理服务",Summary="批量删除",Key="C9E5F9B494BBF428A85ECEA53B095285",Description="根据多个主键批量删除",Path="/api/position/deletes",Method=(HttpMethodType)1,CreatedTime= DateTimeOffset.Now},
 ...
 new Function(){Id = Guid.Parse("61cc62e4-34da-4a0a-9899-488d3ab399fa"),EnableAudit=true,Group="系统管理",Service="岗位管理服务",Summary="删除",Key="34B7575A20F0D8D6B1B2522F9DD7A7B8",Description="根据主键删除一条数据",Path="/api/position/{id}",Method=(HttpMethodType)3,CreatedTime= DateTimeOffset.Now},
 new Function(){Id = Guid.Parse("05153ee4-dc99-4834-b398-5999f7dc8d01"),EnableAudit=true,Group="系统管理",Service="岗位管理服务",Summary="更新",Key="47FEFB8B545A5A813AB9ABA70F02BD49",Description="更新一条数据",Path="/api/position",Method=(HttpMethodType)2,CreatedTime= DateTimeOffset.Now},
 new Function(){Id = Guid.Parse("715a2905-da23-405d-98a0-1a1222f7d101"),EnableAudit=false,Group="系统管理",Service="岗位管理服务",Summary="根据主键获取",Key="DF0B66D0FC43BB25047A470707E01EF8",Description="根据主键查找一条数据",Path="/api/position/{id}",Method=(HttpMethodType)0,CreatedTime= DateTimeOffset.Now},
 new Function(){Id = Guid.Parse("e8060504-9fce-43a4-a7f0-7818c2de567e"),EnableAudit=false,Group="系统管理",Service="岗位管理服务",Summary="搜索",Key="8B38909A67FDFE704F49AFB6AF35995A",Description="搜索岗位数据",Path="/api/position/search/{pageindex}/{pagesize}",Method=(HttpMethodType)0,CreatedTime= DateTimeOffset.Now},
 new Function(){Id = Guid.Parse("65a3c1ee-f5cf-48eb-9bf0-3d4db44257e4"),EnableAudit=true,Group="系统管理",Service="岗位管理服务",Summary="逻辑删除",Key="BB0B0620A9F5665B13ADC8D8C8B8F98A",Description="根据主键逻辑删除",Path="/api/position/fake-delete/{id}",Method=(HttpMethodType)3,CreatedTime= DateTimeOffset.Now},
 ...
 new Function(){Id = Guid.Parse("7a3399b3-6003-4aae-8e24-2e478992630e"),EnableAudit=true,Group="系统管理",Service="岗位管理服务",Summary="添加",Key="1EB184263BA127C79364162F4E75E660",Description="添加一条数据",Path="/api/position",Method=(HttpMethodType)1,CreatedTime= DateTimeOffset.Now},
 new Function(){Id = Guid.Parse("23f69ca2-fcef-4cc7-93ac-484a1e38ba22"),EnableAudit=false,Group="系统管理",Service="用户登录TOKEN服务",Summary="搜索",Key="6707D74A420C1B835267E8F89B2A733C",Description="搜索数据",Path="/api/user-token/search",Method=(HttpMethodType)1,CreatedTime= DateTimeOffset.Now},
 new Function(){Id = Guid.Parse("5eb3ac07-56a4-401f-86c5-686a512663ce"),EnableAudit=true,Group="系统管理",Service="用户登录TOKEN服务",Summary="添加",Key="B8C5050A9AF405D498549684AFBE6BA5",Description="添加一条数据",Path="/api/user-token",Method=(HttpMethodType)1,CreatedTime= DateTimeOffset.Now},
 new Function(){Id = Guid.Parse("36843f91-b2dd-4be2-81bb-98ae3ca02905"),EnableAudit=true,Group="系统管理",Service="用户登录TOKEN服务",Summary="更新",Key="20A3A8A905329855BDB1538D1FC4952E",Description="更新一条数据",Path="/api/user-token",Method=(HttpMethodType)2,CreatedTime= DateTimeOffset.Now},
 new Function(){Id = Guid.Parse("994bcc67-2758-4b1d-894c-1ff8aa234aa9"),EnableAudit=true,Group="系统管理",Service="用户登录TOKEN服务",Summary="删除",Key="F246AC8F372EBBB4DBA7FD9E387C78CF",Description="根据主键删除一条数据",Path="/api/user-token/{id}",Method=(HttpMethodType)3,CreatedTime= DateTimeOffset.Now},
 new Function(){Id = Guid.Parse("29d09bb6-202c-43d4-b223-1bab9a8110c7"),EnableAudit=false,Group="系统管理",Service="用户登录TOKEN服务",Summary="根据主键获取",Key="F644EA520FFD15E462A5C058F5B034B3",Description="根据主键查找一条数据",Path="/api/user-token/{id}",Method=(HttpMethodType)0,CreatedTime= DateTimeOffset.Now},
 new Function(){Id = Guid.Parse("ca7391b0-2691-4bb9-87c5-1230c5f1e00e"),EnableAudit=true,Group="系统管理",Service="用户登录TOKEN服务",Summary="批量删除",Key="B63C74AC690A1F5B2E8C23CD2F4C4A0B",Description="根据多个主键批量删除",Path="/api/user-token/deletes",Method=(HttpMethodType)1,CreatedTime= DateTimeOffset.Now},
 new Function(){Id = Guid.Parse("98fdbccd-fde2-414d-9cfe-0d6cf3339d58"),EnableAudit=true,Group="系统管理",Service="用户登录TOKEN服务",Summary="逻辑删除",Key="FF4F009CAC7CE2915AA92B3864ADD4CF",Description="根据主键逻辑删除",Path="/api/user-token/fake-delete/{id}",Method=(HttpMethodType)3,CreatedTime= DateTimeOffset.Now},
 new Function(){Id = Guid.Parse("453f751d-70d5-4725-ac7c-ad083bd5253d"),EnableAudit=true,Group="系统管理",Service="用户登录TOKEN服务",Summary="批量逻辑删除",Key="3176F9202C7FE094C0BCDBA6E428E1F4",Description="根据多个主键批量逻辑删除",Path="/api/user-token/fake-deletes",Method=(HttpMethodType)1,CreatedTime= DateTimeOffset.Now},
 new Function(){Id = Guid.Parse("9b54a63a-b157-4bd3-adcc-daa0e248edc6"),EnableAudit=false,Group="系统管理",Service="用户登录TOKEN服务",Summary="查询所有",Key="75D578DDEE9C4085A751D6DD1C66F861",Description="查找到所有数据",Path="/api/user-token/all",Method=(HttpMethodType)0,CreatedTime= DateTimeOffset.Now},
 new Function(){Id = Guid.Parse("025150b5-37a7-4f19-b8a2-187cb1717928"),EnableAudit=false,Group="系统管理",Service="用户登录TOKEN服务",Summary="查询所有可以用的",Key="64B675513AC8714610A3F1E35127EFCE",Description="查询所有可以用的(在有IsDelete、IsLock字段时会自动过滤)",Path="/api/user-token/all-usable",Method=(HttpMethodType)0,CreatedTime= DateTimeOffset.Now},
 new Function(){Id = Guid.Parse("4d23c991-627c-4a7a-8fa5-267c6682115d"),EnableAudit=false,Group="系统管理",Service="用户登录TOKEN服务",Summary="分页查询",Key="12097C2120D203155FD96BDD7EB37F23",Description="根据分页参数，分页获取数据",Path="/api/user-token/page/{pageindex}/{pagesize}",Method=(HttpMethodType)0,CreatedTime= DateTimeOffset.Now},
 new Function(){Id = Guid.Parse("a0e6ea28-fcd8-4c9b-b937-35a2afa10b86"),EnableAudit=true,Group="系统管理",Service="用户登录TOKEN服务",Summary="锁定",Key="DC9409CFC9E16F58BB9584E1445317AD",Description="根据主键锁定或解锁数据（必须有IsLock才能生效）",Path="/api/user-token/{id}/lock/{islocked}",Method=(HttpMethodType)2,CreatedTime= DateTimeOffset.Now}
