...
namespace Gardener.Core.Entites
{
 ...
 new Function(){Id = Guid.Parse("85f94b4c-e897-4f3c-b80a-c7ddb8ebf1b5"),EnableAudit=true,Group="系统管理",Service="部门服务",Summary="搜索",Key="E6BAA5C7F35ED0CBD3902A30349A992B",Description="搜索数据",Path="/api/dept/search",Method=(HttpMethodType)1,CreatedTime= DateTimeOffset.Now},
 new Function(){Id = Guid.Parse("c715a6d5-cd99-4c94-8760-936817c1e09c"),EnableAudit=true,Group="系统管理",Service="岗位管理服务",Summary="搜索",Key="9A501F3D2F0A3A2D47A17D6F42042CD5",Description="搜索数据",Path="/api/position/search",Method=(HttpMethodType)1,CreatedTime= DateTimeOffset.Now},
 ...
 new Function(){Id = Guid.Parse("1295aed2-ae71-411f-9542-d50f75432840"),EnableAudit=true,Group="系统管理",Service="资源服务",Summary="搜索",Key="24C5B533C5DDC7D494830FF5E28F6EC2",Description="搜索数据",Path="/api/resource/search",Method=(HttpMethodType)1,CreatedTime= DateTimeOffset.Now},
 ...
 new Function(){Id = Guid.Parse("498638f7-dc92-4d0e-ac5e-26e48cf87a8d"),EnableAudit=true,Group="系统管理",Service="角色服务",Summary="搜索",Key="4B11C588FC856C862E41859F189370C0",Description="搜索数据",Path="/api/role/search",Method=(HttpMethodType)1,CreatedTime= DateTimeOffset.Now},
 new Function(){Id = Guid.Parse("cbc8aff4-6dc0-41f2-b684-caba8e0657ac"),EnableAudit=true,Group="系统管理",Service="用户服务",Summary="搜索",Key="04608E487B494D4597BBAD83DF59D2FF",Description="搜索用户数据",Path="/api/user/search",Method=(HttpMethodType)1,CreatedTime= DateTimeOffset.Now},
