...
namespace Gardener.Core.Entites
{
 ...
 new Function(){Id = Guid.Parse("39812ff6-2c40-4017-9d11-fd7b13fe2a6b"),EnableAudit=false,Group="系统管理",Service="权限认证服务",Summary="查看用户角色",Key="9F7F841076617DA5F308E11132F7E666",Description="查看当前用户角色",Path="/api/authorize/current-user-roles",Method=(HttpMethod)0,CreatedTime= DateTimeOffset.FromUnixTimeSeconds(1628689405)},
 new Function(){Id = Guid.Parse("03f2bbda-d0d4-429f-9c95-03345d00c2cd"),EnableAudit=false,Group="系统管理",Service="权限认证服务",Summary="获取当前用户信息",Key="8B52F19B65946082EBFB93CE354018DE",Description="获取当前用户信息",Path="/api/authorize/current-user",Method=(HttpMethod)0,CreatedTime= DateTimeOffset.FromUnixTimeSeconds(1628689405)},
 new Function(){Id = Guid.Parse("2eb943e9-5b65-4572-b76e-4ef2de07bcd3"),EnableAudit=false,Group="系统管理",Service="权限认证服务",Summary="获取用户资源",Key="58B28787804A078C4A724AF9A151DEDC",Description="",Path="/api/authorize/current-user-resources",Method=(HttpMethod)0,CreatedTime= DateTimeOffset.FromUnixTimeSeconds(1628689405)},
 ...
 new Function(){Id = Guid.Parse("fe3c8d2c-02ce-4073-a2b5-0b05168e7fc9"),EnableAudit=true,Group="系统管理",Service="权限认证服务",Summary="登录",Key="BBDF1AED32167D0970DA83229C7A8A03",Description="登录接口",Path="/api/authorize/login",Method=(HttpMethod)1,CreatedTime= DateTimeOffset.FromUnixTimeSeconds(1628689405)},
