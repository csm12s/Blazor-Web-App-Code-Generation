...
namespace Gardener.UserCenter.Impl.SeedDatas
{
    ...
    public class TenantManagerResourceSeedData : IEntitySeedData<Resource>
    {
        ...
        {
            return new[]{
                new Resource() {Name="后台租户管理员",Remark="控制全局租户信息的显示，此资源不要分配给租户",Key="system_tenant_administrator",Order=0,ParentId=Guid.Parse("3c124d95-dd76-4903-b240-a4fe4df93868"),Type=Enum.Parse<ResourceType>("Action"),Id=Guid.Parse("62e874c8-d286-4b28-831b-90d0c49f0908"),IsLocked=false,IsDeleted=false,CreatedTime=DateTimeOffset.Parse("2023-05-10 18:13:46"),CreateBy="2",CreateIdentityType=Enum.Parse<IdentityType>("User"),UpdatedTime=DateTimeOffset.Parse("2023-05-11 14:21:38"),UpdateBy="2",UpdateIdentityType=Enum.Parse<IdentityType>("User"),},
