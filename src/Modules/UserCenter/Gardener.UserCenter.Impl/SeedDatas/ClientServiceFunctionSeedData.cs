    ...
    public class ClientServiceFunctionSeedData : IEntitySeedData<Function>
    {
        ...
        public IEnumerable<Function> HasData(DbContext dbContext, Type dbContextLocator)
        {
            return new[]{
                ...
                new Function() {Group="用户中心服务",Service="客户端服务",Summary="根据客户端编号获取绑定的接口列表",Key="AF36C639E9127D2C3B5ECB8FE54D26A4",Description="",Path="/api/client/{id}/functions",Method=Enum.Parse<HttpMethod>("GET"),EnableAudit=false,Id=Guid.Parse("5c0a6241-ac2d-442f-9c6c-028566f18b6a"),IsLocked=false,IsDeleted=false,CreatedTime=DateTimeOffset.Parse("2022-08-08 08:08:08"),},
