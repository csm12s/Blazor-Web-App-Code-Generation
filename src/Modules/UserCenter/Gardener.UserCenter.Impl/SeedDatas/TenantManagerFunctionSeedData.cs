    ...
    public class TenantManagerFunctionSeedData : IEntitySeedData<Function>
    {
        ...
        public IEnumerable<Function> HasData(DbContext dbContext, Type dbContextLocator)
        {
            return new[]{
                ...
                new Function() {Group="用户中心服务",Service="租户服务",Summary="获取租户资源列表",Key="93FF4A02546A74DA1406F440D9C43006",Description="resources",Path="/api/tenant/{tenantid}/resources",Method=Enum.Parse<HttpMethod>("GET"),EnableAudit=false,Id=Guid.Parse("23cd301c-ebbb-4715-a96d-72232d9a6927"),IsLocked=false,IsDeleted=false,CreatedTime=DateTimeOffset.Parse("2023-05-16 18:06:00"),CreateBy="5",CreateIdentityType=Enum.Parse<IdentityType>("User"),},
                new Function() {Group="用户中心服务",Service="租户服务",Summary="为租户添加资源",Key="F17552720E10BFAF2622962F852D4C36",Description="resources",Path="/api/tenant/{tenantid}/resources",Method=Enum.Parse<HttpMethod>("POST"),EnableAudit=true,Id=Guid.Parse("8663473b-4a13-46ce-8187-a850215151fe"),IsLocked=false,IsDeleted=false,CreatedTime=DateTimeOffset.Parse("2023-05-16 18:06:00"),CreateBy="5",CreateIdentityType=Enum.Parse<IdentityType>("User"),},
         };
        }
    }
}
