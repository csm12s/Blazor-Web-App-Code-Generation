    ...
    public class DeptManagerResourceFunctionDtoSeedData : IEntitySeedData<ResourceFunction>
    {
        ...
        public IEnumerable<ResourceFunction> HasData(DbContext dbContext, Type dbContextLocator)
        {
            return new[]{
                ...
                new ResourceFunction() {ResourceId=Guid.Parse("57a8f870-c76f-4ce0-b660-bf6661dc9baf"),FunctionId=Guid.Parse("6e2ff941-1e79-4e2a-bbe9-ec68318e5d3a"),CreatedTime=DateTimeOffset.Parse("2022-09-05 17:47:28"),},
