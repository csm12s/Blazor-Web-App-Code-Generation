    ...
    public class ClientManagerResourceFunctionSeedData : IEntitySeedData<ResourceFunction>
    {
        ...
        public IEnumerable<ResourceFunction> HasData(DbContext dbContext, Type dbContextLocator)
        {
            return new[]{
                ...
                new ResourceFunction() {ResourceId=Guid.Parse("86a086a1-0770-4df4-ade3-433ff7226399"),FunctionId=Guid.Parse("3a6f74c2-0165-46b0-8cd5-1846846d97bc"),CreatedTime=DateTimeOffset.Parse("2021-11-19 08:19:47"),},
