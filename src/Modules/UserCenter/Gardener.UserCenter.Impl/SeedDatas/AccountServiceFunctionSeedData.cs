...
namespace Gardener.UserCenter.SeedDatas
{
    ...
    public class AccountServiceFunctionSeedData : IEntitySeedData<Function>
    {
        ...
        {
            return new[]{
                new Function() {Group="用户中心服务",Service="用户账户认证授权服务",Summary="刷新Token",Key="1549F5F1C34E25281CBC00CA283BC404",Description="通过刷新token获取新的token",Path="/api/account/refresh-token",Method=Enum.Parse<HttpMethod>("POST"),EnableAudit=true,Id=Guid.Parse("03ee6f4b-dfea-4803-9515-3a9b2f907c90"),IsLocked=false,IsDeleted=false,CreatedTime=DateTimeOffset.Parse("2022-08-08 08:08:08"),UpdatedTime=DateTimeOffset.Parse("2022-08-08 08:08:08"),},
                new Function() {Group="用户中心服务",Service="用户账户认证授权服务",Summary="移除当前用户token",Key="34925D025D1D97104B7A51EF41C393F3",Description="移除当前用户token",Path="/api/account/current-user-refresh-token",Method=Enum.Parse<HttpMethod>("DELETE"),EnableAudit=true,Id=Guid.Parse("1c6dfb26-4149-4fa3-a7de-083ad7ff7d6c"),IsLocked=false,IsDeleted=false,CreatedTime=DateTimeOffset.Parse("2022-08-08 08:08:08"),UpdatedTime=DateTimeOffset.Parse("2022-08-08 08:08:08"),},
                new Function() {Group="用户中心服务",Service="用户账户认证授权服务",Summary="获取当前用户信息",Key="2FAAF199BA16D914E7796C0B65B7CD13",Description="获取当前用户信息",Path="/api/account/current-user",Method=Enum.Parse<HttpMethod>("GET"),EnableAudit=false,Id=Guid.Parse("38545a67-61ff-4e5c-90bb-a555a93fcbea"),IsLocked=false,IsDeleted=false,CreatedTime=DateTimeOffset.Parse("2022-08-08 08:08:08"),UpdatedTime=DateTimeOffset.Parse("2022-08-08 08:08:08"),},
                new Function() {Group="用户中心服务",Service="用户账户认证授权服务",Summary="查看用户角色",Key="7F3E99BDC443556613552A21A56D9B73",Description="查看当前用户角色",Path="/api/account/current-user-roles",Method=Enum.Parse<HttpMethod>("GET"),EnableAudit=false,Id=Guid.Parse("68ce42ff-acc7-485f-bc91-df471b520be7"),IsLocked=false,IsDeleted=false,CreatedTime=DateTimeOffset.Parse("2022-08-08 08:08:08"),UpdatedTime=DateTimeOffset.Parse("2022-08-08 08:08:08"),},
                new Function() {Group="用户中心服务",Service="用户账户认证授权服务",Summary="获取用户资源",Key="3F2A1F37C00070D6D3EB4F27E24BB687",Path="/api/account/current-user-resources",Method=Enum.Parse<HttpMethod>("GET"),EnableAudit=false,Id=Guid.Parse("713341f2-47e1-42af-b717-bfa75904d32e"),IsLocked=false,IsDeleted=false,CreatedTime=DateTimeOffset.Parse("2022-08-08 08:08:08"),UpdatedTime=DateTimeOffset.Parse("2022-08-08 08:08:08"),},
                ...
                new Function() {Group="用户中心服务",Service="用户账户认证授权服务",Summary="测试token是否可用",Key="F8F937E7C7DC6514F3C0E1353D4D35FB",Description="不执行任何内容，token无效将响应401",Path="/api/account/test-token",Method=Enum.Parse<HttpMethod>("POST"),EnableAudit=false,Id=Guid.Parse("e0b19b01-4b37-426a-a5c4-749e5936b64c"),IsLocked=false,IsDeleted=false,CreateBy="2",CreateIdentityType=Enum.Parse<IdentityType>("User"),CreatedTime=DateTimeOffset.Parse("2023-04-13 14:06:31"),},
                new Function() {Group="用户中心服务",Service="用户账户认证授权服务",Summary="修改密码",Key="1699D7A77E5536AD5865935029211166",Description="修改当前用户密码",Path="/api/account/change-password",Method=Enum.Parse<HttpMethod>("POST"),EnableAudit=true,Id=Guid.Parse("ff4b3f11-f422-490b-9a13-877eb7a1146b"),IsLocked=false,IsDeleted=false,CreatedTime=DateTimeOffset.Parse("2023-08-21 17:28:45"),CreateBy="2",CreateIdentityType=Enum.Parse<IdentityType>("User"),},
         };
        }
