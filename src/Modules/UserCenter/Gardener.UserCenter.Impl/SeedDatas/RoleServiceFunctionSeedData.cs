    ...
    public class RoleServiceFunctionSeedData : IEntitySeedData<Function>
    {
        ...
        public IEnumerable<Function> HasData(DbContext dbContext, Type dbContextLocator)
        {
            return new[]{
                ...
                new Function() {Group="用户中心服务",Service="角色服务",Summary="搜索",Key="4B11C588FC856C862E41859F189370C0",Description="搜索数据",Path="/api/role/search",Method=Enum.Parse<HttpMethod>("POST"),EnableAudit=false,Id=Guid.Parse("498638f7-dc92-4d0e-ac5e-26e48cf87a8d"),IsLocked=false,IsDeleted=false,CreatedTime=DateTimeOffset.Parse("2022-08-08 08:08:08"),UpdatedTime=DateTimeOffset.Parse("2022-08-08 08:08:08"),},
                ...
                new Function() {Group="用户中心服务",Service="角色服务",Summary="查询所有可以用的",Key="D4F99E0AE4263D647F3440B66DB7AC7B",Description="查询所有可以用的(在有IsDelete、IsLock字段时会自动过滤)",Path="/api/role/all-usable",Method=Enum.Parse<HttpMethod>("GET"),EnableAudit=false,Id=Guid.Parse("5efd6ab4-a9d3-4742-9a48-fb54a1b1e463"),IsLocked=false,IsDeleted=false,CreatedTime=DateTimeOffset.Parse("2022-08-08 08:08:08"),UpdatedTime=DateTimeOffset.Parse("2022-08-08 08:08:08"),},
                new Function() {Group="用户中心服务",Service="角色服务",Summary="获取种子数据",Key="72B515FB99A1EFE42DEFCFC12954F93D",Description="获取种子数据",Path="/api/role/role-resource-seed-data",Method=Enum.Parse<HttpMethod>("GET"),EnableAudit=false,Id=Guid.Parse("63d7208e-45d3-406e-a4a1-c87e3afda04d"),IsLocked=false,IsDeleted=false,CreatedTime=DateTimeOffset.Parse("2022-08-08 08:08:08"),UpdatedTime=DateTimeOffset.Parse("2022-08-08 08:08:08"),},
                ...
                new Function() {Group="用户中心服务",Service="角色服务",Summary="根据角色编号删除所有资源",Key="DECA4ECA67D27FC9932271EE3B0AC5DD",Description="根据角色编号删除所有资源",Path="/api/role/{roleid}/resource",Method=Enum.Parse<HttpMethod>("DELETE"),EnableAudit=true,Id=Guid.Parse("94f22c97-ae4a-40e0-95cd-d0a6347eacd7"),IsLocked=false,IsDeleted=false,CreatedTime=DateTimeOffset.Parse("2022-08-08 08:08:08"),UpdatedTime=DateTimeOffset.Parse("2022-08-08 08:08:08"),},
                new Function() {Group="用户中心服务",Service="角色服务",Summary="分页查询",Key="5CF48BAB60B771300975D93C49925CA0",Description="根据分页参数，分页获取数据",Path="/api/role/page/{pageindex}/{pagesize}",Method=Enum.Parse<HttpMethod>("GET"),EnableAudit=false,Id=Guid.Parse("9d9233d8-df0a-43b7-929a-65b9bd532c8c"),IsLocked=false,IsDeleted=false,CreatedTime=DateTimeOffset.Parse("2022-08-08 08:08:08"),UpdatedTime=DateTimeOffset.Parse("2022-08-08 08:08:08"),},
                new Function() {Group="用户中心服务",Service="角色服务",Summary="删除",Key="1A6C9AC4F4D71B0FC154AD8CE6FE6D29",Description="根据主键删除一条数据",Path="/api/role/{id}",Method=Enum.Parse<HttpMethod>("DELETE"),EnableAudit=true,Id=Guid.Parse("a4a2536b-1cc6-438c-ba00-054e16fc2c7c"),IsLocked=false,IsDeleted=false,CreatedTime=DateTimeOffset.Parse("2022-08-08 08:08:08"),UpdatedTime=DateTimeOffset.Parse("2022-08-08 08:08:08"),},
                ...
                new Function() {Group="用户中心服务",Service="角色服务",Summary="根据主键获取",Key="CC8DA87E574A106E9B14287FEC850037",Description="根据主键查找一条数据",Path="/api/role/{id}",Method=Enum.Parse<HttpMethod>("GET"),EnableAudit=false,Id=Guid.Parse("cba739f0-9f8a-40c2-afff-d66c3382e096"),IsLocked=false,IsDeleted=false,CreatedTime=DateTimeOffset.Parse("2022-08-08 08:08:08"),UpdatedTime=DateTimeOffset.Parse("2022-08-08 08:08:08"),},
