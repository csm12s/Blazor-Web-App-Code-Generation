    ...
    public class PositionServiceFunctionSeedData : IEntitySeedData<Function>
    {
        ...
        public IEnumerable<Function> HasData(DbContext dbContext, Type dbContextLocator)
        {
            return new[]{
                ...
                new Function() {Group="用户中心服务",Service="岗位管理服务",Summary="搜索",Key="9A501F3D2F0A3A2D47A17D6F42042CD5",Description="搜索数据",Path="/api/position/search",Method=Enum.Parse<HttpMethod>("POST"),EnableAudit=true,Id=Guid.Parse("c715a6d5-cd99-4c94-8760-936817c1e09c"),IsLocked=false,IsDeleted=false,CreatedTime=DateTimeOffset.Parse("2022-08-08 08:08:08"),UpdatedTime=DateTimeOffset.Parse("2022-08-08 08:08:08"),},
