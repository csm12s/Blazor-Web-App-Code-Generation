...
namespace Gardener.UserCenter.SeedDatas
{
    ...
    public class UserServiceFunctionSeedData : IEntitySeedData<Function>
    {
        ...
        {
            return new[]{
                new Function() {Group="用户中心服务",Service="用户服务",Summary="生成种子数据",Key="071E85AC46B630CFCC89C5EAF1E23F68",Description="根据搜索条叫生成种子数据",Path="/api/user/generate-seed-data",Method=Enum.Parse<HttpMethod>("POST"),EnableAudit=true,Id=Guid.Parse("a6db8946-339f-423e-8641-902da36d3d39"),IsLocked=false,IsDeleted=false,CreatedTime=DateTimeOffset.Parse("2022-08-08 08:08:08"),UpdatedTime=DateTimeOffset.Parse("2022-08-08 08:08:08"),},
                new Function() {Group="用户中心服务",Service="用户服务",Summary="逻辑删除",Key="02836036DDDF7900E5F5E9762F5E4229",Description="根据主键逻辑删除",Path="/api/user/fake-delete/{id}",Method=Enum.Parse<HttpMethod>("DELETE"),EnableAudit=true,Id=Guid.Parse("0b605fe1-c77c-4735-8320-b8f400163ac9"),IsLocked=false,IsDeleted=false,CreatedTime=DateTimeOffset.Parse("2022-08-08 08:08:08"),UpdatedTime=DateTimeOffset.Parse("2022-08-08 08:08:08"),},
                new Function() {Group="用户中心服务",Service="用户服务",Summary="更新头像",Key="FEBD6097BE29268FDFDC295C98A9AD9F",Description="更新用户的头像",Path="/api/user/avatar",Method=Enum.Parse<HttpMethod>("PUT"),EnableAudit=true,Id=Guid.Parse("0c6f2138-e984-4fba-ad2a-2890716a7259"),IsLocked=false,IsDeleted=false,CreatedTime=DateTimeOffset.Parse("2022-08-08 08:08:08"),UpdatedTime=DateTimeOffset.Parse("2022-08-08 08:08:08"),},
                new Function() {Group="用户中心服务",Service="用户服务",Summary="设置角色",Key="A843DEF0CDD97A394996DCF7C5E80F5B",Description="给用户设置角色",Path="/api/user/{userid}/role",Method=Enum.Parse<HttpMethod>("POST"),EnableAudit=true,Id=Guid.Parse("0d2e0194-2238-457b-aab0-9b3259cc4ed9"),IsLocked=false,IsDeleted=false,CreatedTime=DateTimeOffset.Parse("2022-08-08 08:08:08"),UpdatedTime=DateTimeOffset.Parse("2022-08-08 08:08:08"),},
                new Function() {Group="用户中心服务",Service="用户服务",Summary="查询所有",Key="9B0AD48E75A6C37EDC7101236F93CF77",Description="查找到所有数据",Path="/api/user/all",Method=Enum.Parse<HttpMethod>("GET"),EnableAudit=false,Id=Guid.Parse("1562071d-e18c-4d29-a854-12a562961140"),IsLocked=false,IsDeleted=false,CreatedTime=DateTimeOffset.Parse("2022-08-08 08:08:08"),UpdatedTime=DateTimeOffset.Parse("2022-08-08 08:08:08"),},
                ...
                new Function() {Group="用户中心服务",Service="用户服务",Summary="查看用户权限",Key="FAA3B104E6EBF3B5F16DB92C56836A63",Description="查看用户权限",Path="/api/user/{userid}/resources",Method=Enum.Parse<HttpMethod>("GET"),EnableAudit=false,Id=Guid.Parse("39ccceae-2cba-4cd2-a44b-fc8fe8a3f2e4"),IsLocked=false,IsDeleted=false,CreatedTime=DateTimeOffset.Parse("2022-08-08 08:08:08"),UpdatedTime=DateTimeOffset.Parse("2022-08-08 08:08:08"),},
                new Function() {Group="用户中心服务",Service="用户服务",Summary="分页查询",Key="5FFF46E52DE5943FA225B0F6E29A338D",Description="根据分页参数，分页获取数据",Path="/api/user/page/{pageindex}/{pagesize}",Method=Enum.Parse<HttpMethod>("GET"),EnableAudit=false,Id=Guid.Parse("3e2f4464-6b69-4a00-acfb-d39184729cdd"),IsLocked=false,IsDeleted=false,CreatedTime=DateTimeOffset.Parse("2022-08-08 08:08:08"),UpdatedTime=DateTimeOffset.Parse("2022-08-08 08:08:08"),},
                ...
                new Function() {Group="用户中心服务",Service="用户服务",Summary="批量逻辑删除",Key="3E010DCA7BAD6C3FCCCA32FB77F050F0",Description="根据多个主键批量逻辑删除",Path="/api/user/fake-deletes",Method=Enum.Parse<HttpMethod>("POST"),EnableAudit=true,Id=Guid.Parse("6aea8a77-edd2-444b-b8be-901d78321a49"),IsLocked=false,IsDeleted=false,CreatedTime=DateTimeOffset.Parse("2022-08-08 08:08:08"),UpdatedTime=DateTimeOffset.Parse("2022-08-08 08:08:08"),},
                ...
                new Function() {Group="用户中心服务",Service="用户服务",Summary="新增",Key="7CBF6D43C3F9935BF83629FCEED2FFFB",Description="新增用户",Path="/api/user",Method=Enum.Parse<HttpMethod>("POST"),EnableAudit=true,Id=Guid.Parse("af79d7de-0141-4338-8c52-05216d1b07ff"),IsLocked=false,IsDeleted=false,CreatedTime=DateTimeOffset.Parse("2022-08-08 08:08:08"),UpdatedTime=DateTimeOffset.Parse("2022-08-08 08:08:08"),},
                ...
                new Function() {Group="用户中心服务",Service="用户服务",Summary="搜索",Key="04608E487B494D4597BBAD83DF59D2FF",Description="搜索用户数据",Path="/api/user/search",Method=Enum.Parse<HttpMethod>("POST"),EnableAudit=false,Id=Guid.Parse("cbc8aff4-6dc0-41f2-b684-caba8e0657ac"),IsLocked=false,IsDeleted=false,CreatedTime=DateTimeOffset.Parse("2022-08-08 08:08:08"),UpdatedTime=DateTimeOffset.Parse("2022-08-08 08:08:08"),},
                new Function() {Group="用户中心服务",Service="用户服务",Summary="导出",Key="BF0393C2E61B44E125040F8947AEFB23",Description="导出数据",Path="/api/user/export",Method=Enum.Parse<HttpMethod>("POST"),EnableAudit=true,IsLocked=false,IsDeleted=false,CreateBy="1",CreateIdentityType=Enum.Parse<IdentityType>("User"),CreatedTime=DateTimeOffset.Parse("2022-08-19 18:25:06"),Id=Guid.Parse("b0b9900d-5ff7-4164-957a-9b8d55d5d5bf"),},
         };
        }
