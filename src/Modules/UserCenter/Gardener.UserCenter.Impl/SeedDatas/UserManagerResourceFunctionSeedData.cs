    ...
    public class UserManagerResourceFunctionSeedData : IEntitySeedData<ResourceFunction>
    {
        ...
        public IEnumerable<ResourceFunction> HasData(DbContext dbContext, Type dbContextLocator)
        {
            return new[]{
                ...
                new ResourceFunction() {ResourceId=Guid.Parse("46cad808-0d0b-42bb-a134-3ad6db8ebf54"),FunctionId=Guid.Parse("5efd6ab4-a9d3-4742-9a48-fb54a1b1e463"),CreatedTime=DateTimeOffset.Parse("2023-05-10 17:36:11"),},
                ...
                new ResourceFunction() {ResourceId=Guid.Parse("490bc05f-499e-4f4c-811d-fde4c10be2ed"),FunctionId=Guid.Parse("0d2e0194-2238-457b-aab0-9b3259cc4ed9"),CreatedTime=DateTimeOffset.Parse("2023-05-10 17:32:52"),},
