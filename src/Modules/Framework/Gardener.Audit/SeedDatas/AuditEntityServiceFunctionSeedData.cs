    ...
    public class AuditEntityServiceFunctionSeedData : IEntitySeedData<Function>
    {
        ...
        public IEnumerable<Function> HasData(DbContext dbContext, Type dbContextLocator)
        {
            return new[]{
                ...
                new Function() {Group="系统基础服务",Service="审计数据服务",Summary="搜索",Key="5A7181978F26890284CE44ED28A2F7AA",Description="搜索数据",Path="/api/audit-entity/search",Method=Enum.Parse<HttpMethod>("POST"),EnableAudit=false,Id=Guid.Parse("7fa014c4-08db-4f96-8132-2bf3db32b256"),IsLocked=false,IsDeleted=false,CreatedTime=DateTimeOffset.Parse("2022-08-08 08:08:08"),UpdatedTime=DateTimeOffset.Parse("2022-08-08 08:08:08"),},
                ...
                new Function() {Group="系统基础服务",Service="审计数据服务",Summary="导出",Key="B0929232FD86E71F313EBB348D60B23A",Description="导出数据",Path="/api/audit-entity/export",Method=Enum.Parse<HttpMethod>("POST"),EnableAudit=true,IsLocked=false,IsDeleted=false,CreatorId="1",CreatorIdentityType=Enum.Parse<IdentityType>("User"),CreatedTime=DateTimeOffset.Parse("2022-08-19 18:25:20"),Id=Guid.Parse("547d94df-965f-4833-88fb-c3f66244926c"),},
         };
        }
    }
