    ...
    public class ResourceServiceFunctionSeedData : IEntitySeedData<Function>
    {
        ...
        public IEnumerable<Function> HasData(DbContext dbContext, Type dbContextLocator)
        {
            return new[]{
                ...
                new Function() {Group="系统基础服务",Service="资源服务",Summary="搜索",Key="24C5B533C5DDC7D494830FF5E28F6EC2",Description="搜索数据",Path="/api/resource/search",Method=Enum.Parse<HttpMethod>("POST"),EnableAudit=false,Id=Guid.Parse("1295aed2-ae71-411f-9542-d50f75432840"),IsLocked=false,IsDeleted=false,CreatedTime=DateTimeOffset.Parse("2022-08-08 08:08:08"),UpdatedTime=DateTimeOffset.Parse("2022-08-08 08:08:08"),},
                ...
                new Function() {Group="系统基础服务",Service="资源服务",Summary="查询所有资源",Key="6AFF14D9D209CDEEFFC0E4872E060F42",Description="查询所有资源 按树形结构返回\r\n非租户在所有资源中抽取，租户在自己的资源池中抽取",Path="/api/resource/tree",Method=Enum.Parse<HttpMethod>("GET"),EnableAudit=false,Id=Guid.Parse("e38c1619-0f84-4e55-81c2-0f47992ee33d"),IsLocked=false,IsDeleted=false,CreatedTime=DateTimeOffset.Parse("2022-08-08 08:08:08"),UpdatedTime=DateTimeOffset.Parse("2022-08-08 08:08:08"),},
