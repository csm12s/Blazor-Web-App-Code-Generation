    ...
    public class LoginTokenServiceFunctionSeedData : IEntitySeedData<Function>
    {
        ...
        public IEnumerable<Function> HasData(DbContext dbContext, Type dbContextLocator)
        {
            return new[]{
                ...
                new Function() {Group="系统基础服务",Service="用户登录TOKEN服务",Summary="搜索",Key="860A62FFC20FAAAE60E760D4305104DF",Description="搜索数据",Path="/api/login-token/search",Method=Enum.Parse<HttpMethod>("POST"),EnableAudit=true,Id=Guid.Parse("e651d9a4-9d6d-44c7-a833-08da6ed19892"),IsLocked=false,IsDeleted=false,CreatedTime=DateTimeOffset.Parse("2022-08-08 08:08:08"),UpdatedTime=DateTimeOffset.Parse("2022-08-08 08:08:08"),},
