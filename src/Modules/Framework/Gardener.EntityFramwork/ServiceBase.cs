...
namespace Gardener.EntityFramwork
{
    ...
    public abstract class ServiceBaseNoKey<TEntity, TEntityDto, TDbContextLocator> : IDynamicApiController, IServiceBaseNoKey<TEntityDto> where TEntity : class, IPrivateEntity, new() where TEntityDto : class, new() where TDbContextLocator : class, IDbContextLocator
    {
        /// <summary>
        /// TEntity Repository
        /// </summary>
        ...
        protected ServiceBaseNoKey(IRepository<TEntity, TDbContextLocator> repository)
        {
        ...
        /// </summary>
        /// <param name="repository"></param>
        protected ServiceBaseNoKey(IRepository<TEntity> repository)
        {
    ...
    public abstract class ServiceBaseNoKey<TEntity, TEntityDto>: ServiceBaseNoKey<TEntity, TEntityDto, MasterDbContextLocator> where TEntity : class, IPrivateEntity, new() where TEntityDto : class, new()
    {
        ...
        /// </summary>
        /// <param name="repository"></param>
        protected ServiceBaseNoKey(IRepository<TEntity, MasterDbContextLocator> repository) : base(repository)
        {
        }
        ...
        /// </summary>
        /// <param name="repository"></param>
        protected ServiceBaseNoKey(IRepository<TEntity> repository) : base(repository)
        {
        }
    }
    ...
    public abstract class ServiceBase<TEntity, TEntityDto, TKey, TDbContextLocator> : ServiceBaseNoKey<TEntity, TEntityDto, TDbContextLocator> where TEntity : class, IPrivateEntity, new() where TEntityDto : class, new() where TDbContextLocator : class, IDbContextLocator
    {
        ...
        /// </summary>
        /// <param name="repository"></param>
        protected ServiceBase(IRepository<TEntity, TDbContextLocator> repository) : base(repository)
        {
        }
