    ...
    public class FunctionSeedData : IEntitySeedData<Function>
    {
        ...
        public IEnumerable<Function> HasData(DbContext dbContext, Type dbContextLocator)
        {
            return new[]{
                ...
                new Function() {Group="系统基础服务",Service="任务调度服务",Summary="导出",Key="A1BCA09FC8FF82506B93BFD5FCD6FCF5",Description="导出数据",Path="/api/sys-timer/export",Method=Enum.Parse<HttpMethod>("POST"),EnableAudit=true,IsLocked=false,IsDeleted=false,CreatorId="1",CreatorIdentityType=Enum.Parse<IdentityType>("User"),CreatedTime=DateTimeOffset.Parse("2022-08-19 18:25:20"),Id=Guid.Parse("ee8b1345-e0c0-47a7-9e85-cb0bd7ede472"),},
         };
        }
    }
