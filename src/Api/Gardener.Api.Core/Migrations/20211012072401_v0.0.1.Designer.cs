...
namespace Gardener.Api.Core.Migrations
{
    ...
    [Migration("20211012072401_v0.0.1")]
    partial class v001
    {
            ...
            modelBuilder.Entity("Gardener.UserCenter.Impl.Domains.Function", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            CreatedTime = 1306001819279360000L,
            ...
            modelBuilder.Entity("Gardener.UserCenter.Impl.Domains.Resource", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            CreatedTime = 1306001818583040000L,
                            Icon = "apartment",
                            IsDeleted = false,
                            IsLocked = false,
                            Key = "root",
            ...
            modelBuilder.Entity("Gardener.UserCenter.Impl.Domains.ResourceFunction", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            CreatedTime = 1306001818603520000L
                        },
                        new
                        {
            ...
            modelBuilder.Entity("Gardener.UserCenter.Impl.Domains.RoleResource", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            RoleId = 2,
                            ResourceId = new Guid("068f13c5-7830-473b-bcc0-f0c2bcaeb558"),
                            CreatedTime = 1306001818214400000L
                        },
                        new
                        {
                            RoleId = 2,
