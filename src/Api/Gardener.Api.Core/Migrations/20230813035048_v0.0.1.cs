    ...
    public partial class v001 : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { new Guid("00553573-3f38-4b36-a14d-8e7b02385227"), "1", 1, 1307170259722240480L, "更新一条数据", true, "定时任务服务", false, false, "FA7A37CB27B4123695BBECFD6367477F", 2, "/api/sys-job-cluster", "定时任务-集群服务", "更新", null, null, null },
                    { new Guid("010c6209-af3b-42e6-9aac-bf364a430b4a"), "1", 1, 1307170259722240480L, "根据主键锁定或解锁数据（必须实现Gardener.Base.IModelLocked才能生效）", true, "定时任务服务", false, false, "B28B50D83638ACB6736816E840C51258", 2, "/api/sys-job-cluster/{id}/lock/{islocked}", "定时任务-集群服务", "锁定", null, null, null },
                    ...
                    { new Guid("0e09e9cd-1cdd-4e61-85cd-51bcc1595ed5"), "1", 1, 1307187666493440480L, "根据主键删除一条数据", true, "定时任务服务", false, false, "294EBF9A693BCEB4275EFC8E42672421", 3, "/api/sys-job-log/{id}", "定时任务-执行日志", "删除", null, null, null },
                    { new Guid("0ed7905f-7825-4f7f-8a00-18cd2da1e89b"), "1", 1, 1307187666513920480L, "搜索数据", true, "定时任务服务", false, false, "031BF6B2A5FFEE9BFB7DE241462FDA13", 1, "/api/sys-job-log/search", "定时任务-执行日志", "搜索", null, null, null },
                    ...
                    { new Guid("12e93db7-e84c-4778-8320-716cbd007e5c"), "1", 1, 1307170259701760480L, "根据多个主键批量删除", true, "定时任务服务", false, false, "E16BDE0C7B55DB96AB16ABEBD1A265A6", 1, "/api/sys-job-cluster/deletes", "定时任务-集群服务", "批量删除", null, null, null },
                    ...
                    { new Guid("193923dc-e968-4e75-9531-b090ffae7eb7"), "1", 1, 1307170259865600480L, "start", true, "定时任务服务", false, false, "9C06292396D2C4D79789365C2DA6018F", 1, "/api/sys-job-trigger/{id}/start", "定时任务-触发器服务", "启动触发器", null, null, null },
                    ...
                    { new Guid("1d2e4602-d6a7-458c-9b76-638bcb8e8e41"), "1", 1, 1307170259804160480L, "根据主键锁定或解锁数据（必须实现Gardener.Base.IModelLocked才能生效）", true, "定时任务服务", false, false, "2D6347AFACD73B12DF7497D52645A457", 2, "/api/sys-job-detail/{id}/lock/{islocked}", "定时任务-任务服务", "锁定", null, null, null },
                    ...
                    { new Guid("2032eead-2715-4f84-9cb1-2e7bcadad2ab"), "1", 1, 1307170259763200480L, "{id}", true, "定时任务服务", false, false, "88C0D3FA08913DAD27E6753C67F4966B", 3, "/api/sys-job-detail/{id}", "定时任务-任务服务", "删除作业", null, null, null },
                    ...
                    { new Guid("243c2cfc-882c-4ee8-8089-381940ae95b3"), "1", 1, 1307170259865600480L, "根据主键锁定或解锁数据（必须实现Gardener.Base.IModelLocked才能生效）", true, "定时任务服务", false, false, "A971718E3DB3188F657CFB6005EC46B0", 2, "/api/sys-job-trigger/{id}/lock/{islocked}", "定时任务-触发器服务", "锁定", null, null, null },
                    { new Guid("249577f0-a0e4-42ea-beed-2a035533933f"), "1", 1, 1307187667025920480L, "save-my-config", true, "定时任务服务", false, false, "38E5B2CA0F23B044D942A3DA7B0B6753", 1, "/api/sys-job-user-config/save-my-config", "定时任务-用户配置服务", "保存我的配置", null, null, null },
                    ...
                    { new Guid("25c5b700-f0b1-401a-8e8b-595871ec07d2"), "1", 1, 1307170259804160480L, "cancel-sleep", true, "定时任务服务", false, false, "8D85FAA54FEC4704B8DFC96869731384", 1, "/api/sys-job-detail/cancel-sleep", "定时任务-任务服务", "强制唤醒作业调度器", null, null, null },
                    { new Guid("266ffe8c-5b42-49c0-8766-90b9b873c936"), "1", 1, 1307187666513920480L, "根据搜索条叫生成种子数据", true, "定时任务服务", false, false, "F1DF6F9C151F1EEE2913A6AE951B6DA4", 1, "/api/sys-job-log/generate-seed-data", "定时任务-执行日志", "生成种子数据", null, null, null },
                    ...
                    { new Guid("26afb233-f6cc-47bb-b367-0b0b7ce3fe42"), "1", 1, 1307187666493440480L, "根据主键查找一条数据", false, "定时任务服务", false, false, "3F6FDE46F3B4734DFAFECC355C9F0247", 0, "/api/sys-job-log/{id}", "定时任务-执行日志", "根据主键获取", null, null, null },
                    ...
                    { new Guid("29e9de55-7f46-4ffe-8b16-4b928046a679"), "1", 1, 1307170259763200480L, "获取作业分页列表", true, "定时任务服务", false, false, "0BFE4E9CB17E57D7392BB456852BB4A4", 1, "/api/sys-job-detail/search", "定时任务-任务服务", "获取作业分页列表", null, null, null },
                    ...
                    { new Guid("2f2ac0d9-9544-4d5d-95f7-adbb4171e4ad"), "1", 1, 1307170259886080480L, "搜索数据", false, "定时任务服务", false, false, "44D6877ADF12C7DDD6522B38E10AD12F", 1, "/api/sys-job-trigger/search", "定时任务-触发器服务", "搜索", "1", 1, 1307170261176320480L },
                    ...
                    { new Guid("2facf11b-2c54-4707-9595-1d9de825896f"), "1", 1, 1307170259783680480L, "start", true, "定时任务服务", false, false, "EB2C0C58149EDD4DC2FFE0AC73C6622D", 1, "/api/sys-job-detail/{id}/start", "定时任务-任务服务", "启动作业", null, null, null },
                    ...
                    { new Guid("36b5de47-1593-4bdd-a560-b0dcbafec479"), "1", 1, 1307170259824640480L, "根据分页参数，分页获取数据", false, "定时任务服务", false, false, "18E4317FFFF340A907659C39388E5E7F", 0, "/api/sys-job-detail/page/{pageindex}/{pagesize}", "定时任务-任务服务", "分页查询", null, null, null },
                    ...
                    { new Guid("37bbd6b1-d02e-4a58-9b86-f5040fb64ca6"), "1", 1, 1307170259701760480L, "根据主键逻辑删除", true, "定时任务服务", false, false, "14D15BBD93AFE26B4E612AE1B2142FFB", 3, "/api/sys-job-cluster/fake-delete/{id}", "定时任务-集群服务", "逻辑删除", null, null, null },
                    ...
                    { new Guid("38c2fd8d-2b26-49c4-8628-6ab902b6fbd1"), "1", 1, 1307187666493440480L, "根据多个主键批量逻辑删除", true, "定时任务服务", false, false, "BBAE20709D963C9CDE52C8D4136501FC", 1, "/api/sys-job-log/fake-deletes", "定时任务-执行日志", "批量逻辑删除", null, null, null },
                    ...
                    { new Guid("3e647086-ddb3-4805-a398-76fdcda0c38b"), "1", 1, 1307170259681280480L, "crash", true, "定时任务服务", false, false, "7F04CE6DC826FC46970D7A966A97B030", 1, "/api/sys-job-cluster/crash", "定时任务-集群服务", "当前作业调度器宕机", null, null, null },
                    { new Guid("3eb56a7c-5d33-417f-a25f-d6fb0313e7b9"), "1", 1, 1307170259824640480L, "查询所有可以用的记录，(实现Gardener.Base.IModelDeletedGardener.Base.IModelLocked时会自动过滤)", false, "定时任务服务", false, false, "0C1E3AF5928F44C16B6C450757107BF2", 0, "/api/sys-job-detail/all-usable", "定时任务-任务服务", "查询所有可以用的", null, null, null },
                    ...
                    { new Guid("3f591c5b-d62c-40ae-99a5-a831f162c1d0"), "1", 1, 1307170259886080480L, "根据分页参数，分页获取数据", false, "定时任务服务", false, false, "3DB691C14996A10C6B1DB22AEC3A3B20", 0, "/api/sys-job-trigger/page/{pageindex}/{pagesize}", "定时任务-触发器服务", "分页查询", null, null, null },
                    ...
                    { new Guid("447cd9f2-4fce-4773-ac11-3151c0d409ab"), "1", 1, 1307187666513920480L, "查找到所有数据", false, "定时任务服务", false, false, "E266CA5054C33D6E517A79A0C08439CA", 0, "/api/sys-job-log/all", "定时任务-执行日志", "查询所有", null, null, null },
                    ...
                    { new Guid("4827dfb4-a7ca-40e7-9f1e-f40d3e06154a"), "1", 1, 1307170259701760480L, "根据多个主键批量逻辑删除", true, "定时任务服务", false, false, "E05FA485A9B7F755731843431FEFD138", 1, "/api/sys-job-cluster/fake-deletes", "定时任务-集群服务", "批量逻辑删除", null, null, null },
                    ...
                    { new Guid("539f1ab4-c233-4784-b799-114ca7804abc"), "1", 1, 1307170259701760480L, "根据主键查找一条数据", false, "定时任务服务", false, false, "D9933D6648C8963EB5526C4D69AB9DD3", 0, "/api/sys-job-cluster/{id}", "定时任务-集群服务", "根据主键获取", null, null, null },
                    ...
                    { new Guid("60012cd5-1fed-47f9-bd06-1c0f636ec849"), "1", 1, 1307187666493440480L, "根据主键锁定或解锁数据（必须实现Gardener.Base.IModelLocked才能生效）", true, "定时任务服务", false, false, "6669B8BF7342B215BEA3CF99CCEF3021", 2, "/api/sys-job-log/{id}/lock/{islocked}", "定时任务-执行日志", "锁定", null, null, null },
                    ...
                    { new Guid("6701f6a8-4a7f-4227-980b-ee83c0521dfe"), "1", 1, 1307170259804160480L, "start-all", true, "定时任务服务", false, false, "A2B39105DE1F36B4B4C677C46B9DF054", 1, "/api/sys-job-detail/start-all", "定时任务-任务服务", "启动所有作业", null, null, null },
                    ...
                    { new Guid("6d0bdc59-8a62-4283-99d2-a586a8e1d191"), "1", 1, 1307187666513920480L, "查询所有可以用的记录，(实现Gardener.Base.IModelDeletedGardener.Base.IModelLocked时会自动过滤)", false, "定时任务服务", false, false, "2159B1467D9C7C4B4EAD35A9688DD546", 0, "/api/sys-job-log/all-usable", "定时任务-执行日志", "查询所有可以用的", null, null, null },
                    { new Guid("6dbeb4e1-2261-46d9-bf5a-47402fcfdb10"), "1", 1, 1307187666513920480L, "添加一条数据", true, "定时任务服务", false, false, "7B13C1DB47BEA797793C821E7CE45C2E", 1, "/api/sys-job-log", "定时任务-执行日志", "添加", null, null, null },
                    ...
                    { new Guid("6f9c2287-753e-42d4-a465-c61dd1820fcf"), "1", 1, 1307170259845120480L, "sys-job-trigger", true, "定时任务服务", false, false, "706122723A90FAEA667B09B6C1674586", 1, "/api/sys-job-trigger", "定时任务-触发器服务", "添加触发器", null, null, null },
                    ...
                    { new Guid("779b4330-2c14-4733-8161-e1230a9db78c"), "1", 1, 1307170259845120480L, "sys-job-trigger", true, "定时任务服务", false, false, "216856E2C1221C97EE992D99475D634C", 2, "/api/sys-job-trigger", "定时任务-触发器服务", "更新触发器", null, null, null },
                    { new Guid("78658122-281d-49e6-b5df-965f6b5cd928"), "1", 1, 1307170259845120480L, "导出数据", true, "定时任务服务", false, false, "0F0E01B3B7600A2878E8F72385DC8D5B", 1, "/api/sys-job-detail/export", "定时任务-任务服务", "导出", null, null, null },
                    ...
                    { new Guid("7d53bd2b-b5c2-4a79-91e7-591bd8bb4d22"), "1", 1, 1307170259865600480L, "pause", true, "定时任务服务", false, false, "D13F607FA2DD2713DD65DD041955C919", 1, "/api/sys-job-trigger/{id}/pause", "定时任务-触发器服务", "暂停触发器", null, null, null },
                    ...
                    { new Guid("7e88962e-c70a-4bf2-9c74-73580272f4c5"), "1", 1, 1307170259742720480L, "导出数据", true, "定时任务服务", false, false, "3AF008ABB9C245E298BB4979FACBBD9A", 1, "/api/sys-job-cluster/export", "定时任务-集群服务", "导出", null, null, null },
                    ...
                    { new Guid("8d2e5d85-7614-4439-8179-7f68e8df98a6"), "1", 1, 1307187666534400480L, "导出数据", true, "定时任务服务", false, false, "9CCF4227F72557BC6FE51375513D60C0", 1, "/api/sys-job-log/export", "定时任务-执行日志", "导出", null, null, null },
                    ...
                    { new Guid("8e3c85a2-f8be-4fc0-9000-76e17ddf02ea"), "1", 1, 1307170259701760480L, "根据主键删除一条数据", true, "定时任务服务", false, false, "5040DEEE517F25D216E5F9386BBD98F2", 3, "/api/sys-job-cluster/{id}", "定时任务-集群服务", "删除", null, null, null },
                    ...
                    { new Guid("902d0f6c-749e-4e63-acd2-31333c0d714b"), "1", 1, 1307170259742720480L, "根据搜索条叫生成种子数据", true, "定时任务服务", false, false, "389F6FFE352F3DFAA30FCE75298B9DD9", 1, "/api/sys-job-cluster/generate-seed-data", "定时任务-集群服务", "生成种子数据", null, null, null },
                    ...
                    { new Guid("979397e7-b307-4332-9bb8-8fd1d9a647de"), "1", 1, 1307170259681280480L, "start", true, "定时任务服务", false, false, "D175B36C107DDB70189298950CE76EBB", 1, "/api/sys-job-cluster/start", "定时任务-集群服务", "当前作业调度器启动通知", null, null, null },
                    ...
                    { new Guid("9ceb36b7-1057-45c5-a0e7-6575799f200e"), "1", 1, 1307170259783680480L, "triggers", false, "定时任务服务", false, false, "A70575154F4DA76A127CCCE27A0B9D09", 0, "/api/sys-job-detail/{id}/triggers", "定时任务-任务服务", "获取触发器列表", null, null, null },
                    ...
                    { new Guid("a03b98e7-d63d-4e24-bfce-bdf7ebef8b43"), "1", 1, 1307170259681280480L, "waiting", true, "定时任务服务", false, false, "CD221DF0530F7DEC732F6D8D5725EF87", 1, "/api/sys-job-cluster/waiting", "定时任务-集群服务", "等待被唤醒", null, null, null },
                    ...
                    { new Guid("a49af65a-b4a7-467b-b990-f3c2f7dc41d0"), "1", 1, 1307170259804160480L, "查找到所有数据", false, "定时任务服务", false, false, "5206FB08975DB96432FC50B6B022ADD3", 0, "/api/sys-job-detail/all", "定时任务-任务服务", "查询所有", null, null, null },
                    ...
                    { new Guid("a95c3584-f7cd-4641-a4ad-397e5a3ea5f4"), "1", 1, 1307170259763200480L, "根据主键查找一条数据", false, "定时任务服务", false, false, "4A4E169C999D217D282DBD9BBCA336A4", 0, "/api/sys-job-detail/{id}", "定时任务-任务服务", "根据主键获取", null, null, null },
                    ...
                    { new Guid("af387085-414a-4429-b4cb-c33d4f8c8b08"), "1", 1, 1307170259906560480L, "导出数据", true, "定时任务服务", false, false, "5DF206D5BE4146D9221F0409813C5DDC", 1, "/api/sys-job-trigger/export", "定时任务-触发器服务", "导出", null, null, null },
                    ...
                    { new Guid("b50c5d91-c9cc-4ada-a3ad-ff54ceeb9867"), "1", 1, 1307170259722240480L, "添加一条数据", true, "定时任务服务", false, false, "CA75C125F921B24F0EAEC77C7D8811EA", 1, "/api/sys-job-cluster", "定时任务-集群服务", "添加", null, null, null },
                    ...
                    { new Guid("b63017f6-d5a9-469f-a682-b0a2ba622f0b"), "1", 1, 1307170259845120480L, "根据主键查找一条数据", false, "定时任务服务", false, false, "D0139AB74A413C492B3F61ADAD7BC3B9", 0, "/api/sys-job-trigger/{id}", "定时任务-触发器服务", "根据主键获取", null, null, null },
                    ...
                    { new Guid("be18722f-c63a-4e0a-8ac5-5e40affd683a"), "1", 1, 1307170259886080480L, "查询所有可以用的记录，(实现Gardener.Base.IModelDeletedGardener.Base.IModelLocked时会自动过滤)", false, "定时任务服务", false, false, "19B18F92EDA27D1FB311472D113B3253", 0, "/api/sys-job-trigger/all-usable", "定时任务-触发器服务", "查询所有可以用的", null, null, null },
                    ...
                    { new Guid("be6df395-460d-4178-aa13-2b3b7d5848fc"), "1", 1, 1307170259783680480L, "pause", true, "定时任务服务", false, false, "C09AEAEC7280AAF5A40F1BC1C44EB17F", 1, "/api/sys-job-detail/{id}/pause", "定时任务-任务服务", "暂停作业", null, null, null },
                    { new Guid("beb703df-93b7-476f-bab9-b39e959de7cb"), "1", 1, 1307170259886080480L, "根据搜索条叫生成种子数据", true, "定时任务服务", false, false, "64C00B08D3BD0ED31F23FC1A435A40B1", 1, "/api/sys-job-trigger/generate-seed-data", "定时任务-触发器服务", "生成种子数据", null, null, null },
                    ...
                    { new Guid("c59d7c7d-968f-44e7-b272-06dcf4a3af80"), "1", 1, 1307187666493440480L, "根据主键逻辑删除", true, "定时任务服务", false, false, "C087B68DD57154402DAA02E2860BE46B", 3, "/api/sys-job-log/fake-delete/{id}", "定时任务-执行日志", "逻辑删除", null, null, null },
                    ...
                    { new Guid("ca4b7fd2-e475-43b6-a11f-7f750c5353e5"), "1", 1, 1307170259742720480L, "搜索数据", true, "定时任务服务", false, false, "920C2BA08C04B360AB86451C77946428", 1, "/api/sys-job-cluster/search", "定时任务-集群服务", "搜索", null, null, null },
                    ...
                    { new Guid("d3aad533-d348-4950-9cf9-942d855cc0ab"), "1", 1, 1307187666513920480L, "根据分页参数，分页获取数据", false, "定时任务服务", false, false, "7E2DA42467945755B177CDB67C6D06E1", 0, "/api/sys-job-log/page/{pageindex}/{pagesize}", "定时任务-执行日志", "分页查询", null, null, null },
                    ...
                    { new Guid("d93c511e-85dc-4ea2-945b-04208cd7209e"), "1", 1, 1307170259783680480L, "pause-all", true, "定时任务服务", false, false, "70D9DBD0B77FF3151247CA5016C52C43", 1, "/api/sys-job-detail/pause-all", "定时任务-任务服务", "暂停所有作业", null, null, null },
                    ...
                    { new Guid("e8e5ebed-ed84-485a-8f51-3ea62ed13af8"), "1", 1, 1307187667025920480L, "my-config", false, "定时任务服务", false, false, "A541E3B27D6BDF23C3252773DD8CC4AF", 0, "/api/sys-job-user-config/my-config", "定时任务-用户配置服务", "获取我的的配置", null, null, null },
                    { new Guid("e90586ea-84da-4317-a838-e8e3606c435a"), "1", 1, 1307170259824640480L, "根据搜索条叫生成种子数据", true, "定时任务服务", false, false, "82E05320B20B349F0E1D372635ADA5E2", 1, "/api/sys-job-detail/generate-seed-data", "定时任务-任务服务", "生成种子数据", null, null, null },
                    ...
                    { new Guid("ed2911d8-c745-4140-90d6-7d82b5252b34"), "1", 1, 1307170259763200480L, "", true, "定时任务服务", false, false, "148C36B57EC8C852F84FC21E844C0163", 1, "/api/sys-job-detail", "定时任务-任务服务", "添加作业", null, null, null },
                    ...
                    { new Guid("ee691438-4f45-4321-aff0-1ab4f9227d36"), "1", 1, 1307187666493440480L, "根据多个主键批量删除", true, "定时任务服务", false, false, "A4705E7A8B52476BB6D41EF3EDF72657", 1, "/api/sys-job-log/deletes", "定时任务-执行日志", "批量删除", null, null, null },
                    ...
                    { new Guid("f1be2be4-b212-4725-9d5b-d99f0d545a64"), "1", 1, 1307170259845120480L, "{id}", true, "定时任务服务", false, false, "61F373C2C626E7C8191F2DD51937E120", 3, "/api/sys-job-trigger/{id}", "定时任务-触发器服务", "删除触发器", null, null, null },
                    { new Guid("f1eb5125-d554-4d6d-ade9-63fe946f68a1"), "1", 1, 1307170259742720480L, "根据分页参数，分页获取数据", false, "定时任务服务", false, false, "0F4BC78106D98D1E9EE125720D15421B", 0, "/api/sys-job-cluster/page/{pageindex}/{pagesize}", "定时任务-集群服务", "分页查询", null, null, null },
                    { new Guid("f308aab6-5ec1-49e0-a5ff-7d8628eaec04"), "1", 1, 1307170259722240480L, "查找到所有数据", false, "定时任务服务", false, false, "0AA28DDDE1B4141C8018EAED7D6FA962", 0, "/api/sys-job-cluster/all", "定时任务-集群服务", "查询所有", null, null, null },
                    { new Guid("f39549ad-0c4b-4afb-9def-d1a12f2e3ac2"), "1", 1, 1307170259804160480L, "persist-all", true, "定时任务服务", false, false, "BA479ECBDB6D8B47F8690F50763178D2", 1, "/api/sys-job-detail/persist-all", "定时任务-任务服务", "强制触发所有作业持久化", null, null, null },
                    ...
                    { new Guid("f71b16b5-22d1-4968-aeeb-bbfc3c53aebf"), "1", 1, 1307170259763200480L, "sys-job-detail", true, "定时任务服务", false, false, "481C508AB16310CE183E3B581DF4F170", 2, "/api/sys-job-detail", "定时任务-任务服务", "更新作业", null, null, null },
                    ...
                    { new Guid("fc1aed1d-95f3-45a6-aedc-5e10608d7ad9"), "1", 1, 1307187666513920480L, "更新一条数据", true, "定时任务服务", false, false, "90C0582034E9DC3F2CC225E2389B1B12", 2, "/api/sys-job-log", "定时任务-执行日志", "更新", null, null, null },
                    ...
                    { new Guid("fd4b7828-d39e-43fd-809c-45a8b029da4b"), "1", 1, 1307170259742720480L, "查询所有可以用的记录，(实现Gardener.Base.IModelDeletedGardener.Base.IModelLocked时会自动过滤)", false, "定时任务服务", false, false, "9B5272E44335CDF2AC923CE65D7E0554", 0, "/api/sys-job-cluster/all-usable", "定时任务-集群服务", "查询所有可以用的", null, null, null },
                    { new Guid("fda58b63-876d-4a07-aff2-a8b7b1cccbf1"), "1", 1, 1307170259865600480L, "查找到所有数据", false, "定时任务服务", false, false, "ED997ECAB452513909149870DBBCD8C9", 0, "/api/sys-job-trigger/all", "定时任务-触发器服务", "查询所有", null, null, null },
                    { new Guid("fe32ce02-5c4a-45f7-9929-1166e3ac4a3f"), "1", 1, 1307170259681280480L, "stop", true, "定时任务服务", false, false, "592A5AEB36B8888B2E6EA31DB3CC5FF4", 1, "/api/sys-job-cluster/stop", "定时任务-集群服务", "当前作业调度器停止通知", null, null, null },
