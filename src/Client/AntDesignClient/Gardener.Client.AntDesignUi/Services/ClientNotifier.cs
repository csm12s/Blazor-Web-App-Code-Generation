...
namespace Gardener.Client.AntDesignUi.Services
{
    ...
    public class ClientNotifier : IClientNotifier
    {
        ...
        {
            return Notify(title ?? localizer[nameof(SharedLocalResource.Error)], description, NotificationType.Error);
        }
        ...
        {
            return Notify(title ?? localizer[nameof(SharedLocalResource.Info)], description, NotificationType.Info);
        }
        ...
        {
            return Notify(title ?? localizer[nameof(SharedLocalResource.Success)], description, NotificationType.Success);
        }
        ...
        {
            return Notify(title ?? localizer[nameof(SharedLocalResource.Warn)], description, NotificationType.Warning);
        }
    }
}
