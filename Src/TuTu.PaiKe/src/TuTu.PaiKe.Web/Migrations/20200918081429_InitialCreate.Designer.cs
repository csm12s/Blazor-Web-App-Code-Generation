...
namespace TuTu.PaiKe.Web.Migrations
{
    ...
    [Migration("20200918081429_InitialCreate")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("TuTu.PaiKe.Authorization.Entities.EntityRole", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("char(36)");
            ...
            modelBuilder.Entity("TuTu.PaiKe.Authorization.Entities.EntityUser", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("char(36)");
            ...
            modelBuilder.Entity("TuTu.PaiKe.Authorization.Entities.Module", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("TuTu.PaiKe.Authorization.Entities.ModuleFunction", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("char(36)");
            ...
            modelBuilder.Entity("TuTu.PaiKe.Authorization.Entities.ModuleRole", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("char(36)");
            ...
            modelBuilder.Entity("TuTu.PaiKe.Authorization.Entities.ModuleUser", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("char(36)");
            ...
            modelBuilder.Entity("TuTu.PaiKe.Identity.Entities.LoginLog", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("char(36)");
            ...
            modelBuilder.Entity("TuTu.PaiKe.Identity.Entities.Organization", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("TuTu.PaiKe.Identity.Entities.Role", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("TuTu.PaiKe.Identity.Entities.RoleClaim", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("TuTu.PaiKe.Identity.Entities.User", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("TuTu.PaiKe.Identity.Entities.UserClaim", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("TuTu.PaiKe.Identity.Entities.UserDetail", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("TuTu.PaiKe.Identity.Entities.UserLogin", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("char(36)");
            ...
            modelBuilder.Entity("TuTu.PaiKe.Identity.Entities.UserRole", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("char(36)");
            ...
            modelBuilder.Entity("TuTu.PaiKe.Identity.Entities.UserToken", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("char(36)");
            ...
            modelBuilder.Entity("TuTu.PaiKe.Infos.Entities.Message", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("char(36)");
            ...
            modelBuilder.Entity("TuTu.PaiKe.Infos.Entities.MessageReceive", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("char(36)");
            ...
            modelBuilder.Entity("TuTu.PaiKe.Infos.Entities.MessageReply", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("char(36)");
            ...
            modelBuilder.Entity("TuTu.PaiKe.Systems.Entities.AuditEntity", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("char(36)");
            ...
            modelBuilder.Entity("TuTu.PaiKe.Systems.Entities.AuditOperation", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("char(36)");
            ...
            modelBuilder.Entity("TuTu.PaiKe.Systems.Entities.AuditProperty", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("char(36)");
            ...
            modelBuilder.Entity("TuTu.PaiKe.Authorization.Entities.EntityRole", b =>
                {
                    ...
                    b.HasOne("TuTu.PaiKe.Identity.Entities.Role", "Role")
                        .WithMany()
            ...
            modelBuilder.Entity("TuTu.PaiKe.Authorization.Entities.EntityUser", b =>
                {
                    ...
                    b.HasOne("TuTu.PaiKe.Identity.Entities.User", "User")
                        .WithMany()
            ...
            modelBuilder.Entity("TuTu.PaiKe.Authorization.Entities.Module", b =>
                {
                    b.HasOne("TuTu.PaiKe.Authorization.Entities.Module", "Parent")
                        .WithMany("Children")
            ...
            modelBuilder.Entity("TuTu.PaiKe.Authorization.Entities.ModuleFunction", b =>
                {
                    ...
                    b.HasOne("TuTu.PaiKe.Authorization.Entities.Module", "Module")
                        .WithMany()
            ...
            modelBuilder.Entity("TuTu.PaiKe.Identity.Entities.Organization", b =>
                {
                    b.HasOne("TuTu.PaiKe.Identity.Entities.Organization", null)
                        .WithMany()
                        .HasForeignKey("ParentId");
                });
            ...
            modelBuilder.Entity("TuTu.PaiKe.Identity.Entities.Role", b =>
                {
                    b.HasOne("TuTu.PaiKe.Infos.Entities.Message", null)
            ...
            modelBuilder.Entity("TuTu.PaiKe.Identity.Entities.UserDetail", b =>
                {
                    b.HasOne("TuTu.PaiKe.Identity.Entities.User", "User")
                        .WithOne("UserDetail")
                        .HasForeignKey("TuTu.PaiKe.Identity.Entities.UserDetail", "UserId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
                });
            ...
            modelBuilder.Entity("TuTu.PaiKe.Infos.Entities.Message", b =>
                {
                    b.HasOne("TuTu.PaiKe.Identity.Entities.User", "Sender")
                        .WithMany()
            ...
            modelBuilder.Entity("TuTu.PaiKe.Infos.Entities.MessageReceive", b =>
                {
                    b.HasOne("TuTu.PaiKe.Infos.Entities.Message", "Message")
                        .WithMany("Receives")
                        .HasForeignKey("MessageId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("TuTu.PaiKe.Infos.Entities.MessageReply", b =>
                {
                    b.HasOne("TuTu.PaiKe.Infos.Entities.Message", "BelongMessage")
                        .WithMany()
                        .HasForeignKey("BelongMessageId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();

                    b.HasOne("TuTu.PaiKe.Infos.Entities.Message", "ParentMessage")
                        .WithMany("Replies")
                        .HasForeignKey("ParentMessageId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();

                    b.HasOne("TuTu.PaiKe.Infos.Entities.MessageReply", "ParentReply")
                        .WithMany("Replies")
            ...
            modelBuilder.Entity("TuTu.PaiKe.Systems.Entities.AuditEntity", b =>
                {
                    b.HasOne("TuTu.PaiKe.Systems.Entities.AuditOperation", "Operation")
            ...
            modelBuilder.Entity("TuTu.PaiKe.Systems.Entities.AuditProperty", b =>
                {
                    b.HasOne("TuTu.PaiKe.Systems.Entities.AuditEntity", "AuditEntity")
                        .WithMany("Properties")
